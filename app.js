...
(function () {
  ...
  const COMPAT_CODES = [
    ...
    { code: "E", headline: "すぐに意気投合できる相性", sub: "お互いがお互いを気遣う", desc: `出会いもそこそこで、すぐに意気投合できる相性です。あらゆる面で話のわかりあえる相手であり、自分とよく似た何かを感じることが多いでしょう。考え方や感じ方がよく似ているため、共通の目的のために仲良く手を取り合って歩んでいくことができます。カップルの場合には、年齢差があるとコンビネーションが実にうまくいき、たとえ、窮地に追い込まれる状況になったとしても、最後まで力を合わせ変容を起こすことができます。まさに、光と影のような一体感のある相性です。しかし、そんな一体感が災いして摩擦を起こしてしまうことも少なくありません。似たものゆえに、反発した時のエネルギーは壮絶を極めます。関わる時間をあまり長く持ちすぎると相手の欠点を通して「自分自身の見たくない課題（シャドウ）」を突きつけられ、息苦しさを感じる機会が増えてしまいます。そのため、時には1人になって適切な距離感を保つことが、この変容のプロセスを健全に進めるための鍵となります。` },
  ...
  const KAISETSU_SECTIONS = [
    ...
    },
    {
      ...
      items: [
        ...
        { type: "info", html: true, open: true, head: "🔄 五行相関図 ── エレメンツが引き起こすこと", body: "<div class=\"det-row\" style=\"line-height:1.9;\">五行の矢印には、ぜんぶ「自然界で起きること」の理由があります。ごちゃごちゃしないように、生む矢印（相生）と消す矢印（相剋）を2枚の輪に分けました。どちらも木がスタートです。</div><svg viewBox=\"0 0 448 442\" style=\"max-width:430px;width:100%;display:block;margin:6px auto;\" xmlns=\"http://www.w3.org/2000/svg\"><defs><marker id=\"sei-ar\" markerWidth=\"7\" markerHeight=\"7\" refX=\"6\" refY=\"3.5\" orient=\"auto\"><path d=\"M0,0 L7,3.5 L0,7 z\" fill=\"#4a8c5c\"/></marker></defs><text x=\"224\" y=\"208\" font-size=\"17\" font-weight=\"bold\" fill=\"#3e8e41\" text-anchor=\"middle\">相生の輪</text><text x=\"224\" y=\"228\" font-size=\"11\" fill=\"#8a7a93\" text-anchor=\"middle\">となりを生む（時計回り）</text><line x1=\"260\" y1=\"120\" x2=\"304\" y2=\"152\" stroke=\"#4a8c5c\" stroke-width=\"3\" marker-end=\"url(#sei-ar)\"/><text x=\"327\" y=\"70\" font-size=\"11.5\" font-weight=\"700\" fill=\"#4a8c5c\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"4\" paint-order=\"stroke\">木がこすれて</text><text x=\"327\" y=\"85\" font-size=\"11.5\" font-weight=\"700\" fill=\"#4a8c5c\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"4\" paint-order=\"stroke\">火が生まれる</text><line x1=\"326\" y1=\"220\" x2=\"309\" y2=\"273\" stroke=\"#4a8c5c\" stroke-width=\"3\" marker-end=\"url(#sei-ar)\"/><text x=\"391\" y=\"266\" font-size=\"11.5\" font-weight=\"700\" fill=\"#4a8c5c\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"4\" paint-order=\"stroke\">燃えたあとの灰が</text><text x=\"391\" y=\"281\" font-size=\"11.5\" font-weight=\"700\" fill=\"#4a8c5c\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"4\" paint-order=\"stroke\">土になる</text><line x1=\"252\" y1=\"315\" x2=\"196\" y2=\"315\" stroke=\"#4a8c5c\" stroke-width=\"3\" marker-end=\"url(#sei-ar)\"/><text x=\"224\" y=\"388\" font-size=\"11.5\" font-weight=\"700\" fill=\"#4a8c5c\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"4\" paint-order=\"stroke\">土の中から</text><text x=\"224\" y=\"403\" font-size=\"11.5\" font-weight=\"700\" fill=\"#4a8c5c\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"4\" paint-order=\"stroke\">金属がとれる</text><line x1=\"139\" y1=\"273\" x2=\"122\" y2=\"220\" stroke=\"#4a8c5c\" stroke-width=\"3\" marker-end=\"url(#sei-ar)\"/><text x=\"57\" y=\"266\" font-size=\"11.5\" font-weight=\"700\" fill=\"#4a8c5c\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"4\" paint-order=\"stroke\">金属の表面に</text><text x=\"57\" y=\"281\" font-size=\"11.5\" font-weight=\"700\" fill=\"#4a8c5c\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"4\" paint-order=\"stroke\">水がうまれる</text><line x1=\"144\" y1=\"152\" x2=\"188\" y2=\"120\" stroke=\"#4a8c5c\" stroke-width=\"3\" marker-end=\"url(#sei-ar)\"/><text x=\"121\" y=\"70\" font-size=\"11.5\" font-weight=\"700\" fill=\"#4a8c5c\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"4\" paint-order=\"stroke\">水が木を</text><text x=\"121\" y=\"85\" font-size=\"11.5\" font-weight=\"700\" fill=\"#4a8c5c\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"4\" paint-order=\"stroke\">育てる</text><circle cx=\"224\" cy=\"94\" r=\"37\" fill=\"#fff\" opacity=\"0.9\" stroke=\"#f0e3f6\" stroke-width=\"2\"/><g transform=\"translate(194,62) scale(0.5)\"><rect x=\"53\" y=\"68\" width=\"14\" height=\"34\" rx=\"6\" fill=\"#a1887f\"/><circle cx=\"36\" cy=\"58\" r=\"17\" fill=\"#66bb6a\"/><circle cx=\"84\" cy=\"58\" r=\"17\" fill=\"#66bb6a\"/><circle cx=\"60\" cy=\"46\" r=\"27\" fill=\"#4caf50\"/><circle cx=\"52\" cy=\"44\" r=\"3\" fill=\"#4a3b2a\"/><circle cx=\"68\" cy=\"44\" r=\"3\" fill=\"#4a3b2a\"/><path d=\"M53 52 Q60 57 67 52\" stroke=\"#4a3b2a\" stroke-width=\"2.5\" fill=\"none\" stroke-linecap=\"round\"/><circle cx=\"44\" cy=\"51\" r=\"4\" fill=\"#f8b4c8\" opacity=\"0.75\"/><circle cx=\"76\" cy=\"51\" r=\"4\" fill=\"#f8b4c8\" opacity=\"0.75\"/></g><text x=\"224\" y=\"125\" font-size=\"13\" font-weight=\"bold\" fill=\"#3e8e41\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"3.5\" paint-order=\"stroke\">木</text><circle cx=\"340\" cy=\"178\" r=\"37\" fill=\"#fff\" opacity=\"0.9\" stroke=\"#f0e3f6\" stroke-width=\"2\"/><g transform=\"translate(310,146) scale(0.5)\"><path transform=\"translate(12,52) scale(0.36)\" d=\"M60 10 C76 32 90 46 90 70 a30 30 0 1 1 -60 0 C30 46 44 32 60 10 Z\" fill=\"#f29db8\"/><path transform=\"translate(64,52) scale(0.36)\" d=\"M60 10 C76 32 90 46 90 70 a30 30 0 1 1 -60 0 C30 46 44 32 60 10 Z\" fill=\"#f29db8\"/><path d=\"M60 10 C76 32 90 46 90 70 a30 30 0 1 1 -60 0 C30 46 44 32 60 10 Z\" fill=\"#e8688f\"/><path d=\"M60 44 C68 54 76 62 76 75 a16 16 0 1 1 -32 0 C44 62 52 54 60 44 Z\" fill=\"#f9c8d8\"/><circle cx=\"53\" cy=\"72\" r=\"3\" fill=\"#4a3b2a\"/><circle cx=\"67\" cy=\"72\" r=\"3\" fill=\"#4a3b2a\"/><path d=\"M54 80 Q60 85 66 80\" stroke=\"#4a3b2a\" stroke-width=\"2.5\" fill=\"none\" stroke-linecap=\"round\"/><circle cx=\"45\" cy=\"79\" r=\"4\" fill=\"#f8b4c8\" opacity=\"0.75\"/><circle cx=\"75\" cy=\"79\" r=\"4\" fill=\"#f8b4c8\" opacity=\"0.75\"/></g><text x=\"340\" y=\"209\" font-size=\"13\" font-weight=\"bold\" fill=\"#d5537e\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"3.5\" paint-order=\"stroke\">火</text><circle cx=\"296\" cy=\"315\" r=\"37\" fill=\"#fff\" opacity=\"0.9\" stroke=\"#f0e3f6\" stroke-width=\"2\"/><g transform=\"translate(266,283) scale(0.5)\"><path d=\"M12 96 Q60 38 108 96 Z\" fill=\"#c9a227\"/><path d=\"M34 78 Q60 62 86 78\" stroke=\"#d9b545\" stroke-width=\"4\" fill=\"none\" stroke-linecap=\"round\"/><rect x=\"10\" y=\"96\" width=\"100\" height=\"8\" rx=\"4\" fill=\"#a58420\"/><path d=\"M60 50 v-16\" stroke=\"#4a8c5c\" stroke-width=\"3.5\" stroke-linecap=\"round\"/><ellipse cx=\"51\" cy=\"30\" rx=\"8\" ry=\"5\" fill=\"#66bb6a\" transform=\"rotate(-32 51 30)\"/><ellipse cx=\"69\" cy=\"30\" rx=\"8\" ry=\"5\" fill=\"#66bb6a\" transform=\"rotate(32 69 30)\"/><circle cx=\"51\" cy=\"80\" r=\"3\" fill=\"#4a3b2a\"/><circle cx=\"69\" cy=\"80\" r=\"3\" fill=\"#4a3b2a\"/><path d=\"M53 88 Q60 93 67 88\" stroke=\"#4a3b2a\" stroke-width=\"2.5\" fill=\"none\" stroke-linecap=\"round\"/><circle cx=\"43\" cy=\"87\" r=\"4\" fill=\"#f8b4c8\" opacity=\"0.75\"/><circle cx=\"77\" cy=\"87\" r=\"4\" fill=\"#f8b4c8\" opacity=\"0.75\"/></g><text x=\"296\" y=\"346\" font-size=\"13\" font-weight=\"bold\" fill=\"#a58420\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"3.5\" paint-order=\"stroke\">土</text><circle cx=\"152\" cy=\"315\" r=\"37\" fill=\"#fff\" opacity=\"0.9\" stroke=\"#f0e3f6\" stroke-width=\"2\"/><g transform=\"translate(122,283) scale(0.5)\"><polygon points=\"60,14 94,46 60,106 26,46\" fill=\"#aab0b9\"/><polygon points=\"60,26 80,47 60,94 40,47\" fill=\"#cfd4da\"/><circle cx=\"52\" cy=\"56\" r=\"3\" fill=\"#4a3b2a\"/><circle cx=\"68\" cy=\"56\" r=\"3\" fill=\"#4a3b2a\"/><path d=\"M54 64 Q60 69 66 64\" stroke=\"#4a3b2a\" stroke-width=\"2.5\" fill=\"none\" stroke-linecap=\"round\"/><circle cx=\"44\" cy=\"63\" r=\"4\" fill=\"#f8b4c8\" opacity=\"0.75\"/><circle cx=\"76\" cy=\"63\" r=\"4\" fill=\"#f8b4c8\" opacity=\"0.75\"/><path transform=\"translate(18,22) scale(0.8)\" d=\"M0 -8 L2 -2 L8 0 L2 2 L0 8 L-2 2 L-8 0 L-2 -2 Z\" fill=\"#ffd54f\"/><path transform=\"translate(100,30) scale(0.6)\" d=\"M0 -8 L2 -2 L8 0 L2 2 L0 8 L-2 2 L-8 0 L-2 -2 Z\" fill=\"#ffd54f\"/></g><text x=\"152\" y=\"346\" font-size=\"13\" font-weight=\"bold\" fill=\"#767c85\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"3.5\" paint-order=\"stroke\">金</text><circle cx=\"108\" cy=\"178\" r=\"37\" fill=\"#fff\" opacity=\"0.9\" stroke=\"#f0e3f6\" stroke-width=\"2\"/><g transform=\"translate(78,146) scale(0.5)\"><path d=\"M60 12 C74 40 88 56 88 76 a28 28 0 1 1 -56 0 C32 56 46 40 60 12 Z\" fill=\"#2f8fe0\"/><ellipse cx=\"47\" cy=\"58\" rx=\"6\" ry=\"11\" fill=\"#fff\" opacity=\"0.35\" transform=\"rotate(-18 47 58)\"/><circle cx=\"52\" cy=\"74\" r=\"4\" fill=\"#fff\"/><circle cx=\"68\" cy=\"74\" r=\"4\" fill=\"#fff\"/><circle cx=\"52\" cy=\"74\" r=\"2\" fill=\"#334\"/><circle cx=\"68\" cy=\"74\" r=\"2\" fill=\"#334\"/><path d=\"M54 82 Q60 87 66 82\" stroke=\"#fff\" stroke-width=\"2.5\" fill=\"none\" stroke-linecap=\"round\"/><circle cx=\"44\" cy=\"81\" r=\"4\" fill=\"#f8b4c8\" opacity=\"0.75\"/><circle cx=\"76\" cy=\"81\" r=\"4\" fill=\"#f8b4c8\" opacity=\"0.75\"/></g><text x=\"108\" y=\"209\" font-size=\"13\" font-weight=\"bold\" fill=\"#2270b8\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"3.5\" paint-order=\"stroke\">水</text></svg><div class=\"det-row\" style=\"line-height:1.9;\">🟢【相生（そうじょう）＝生む・応援する関係】木→火→土→金→水→木。となりのエレメンツにエネルギーを渡していく、めぐみのリレーです。</div><svg viewBox=\"0 0 448 442\" style=\"max-width:430px;width:100%;display:block;margin:6px auto;\" xmlns=\"http://www.w3.org/2000/svg\"><defs><marker id=\"koku-ar\" markerWidth=\"7\" markerHeight=\"7\" refX=\"6\" refY=\"3.5\" orient=\"auto\"><path d=\"M0,0 L7,3.5 L0,7 z\" fill=\"#e05555\"/></marker></defs><text x=\"224\" y=\"208\" font-size=\"17\" font-weight=\"bold\" fill=\"#d5537e\" text-anchor=\"middle\">相剋の輪</text><text x=\"224\" y=\"228\" font-size=\"11\" fill=\"#8a7a93\" text-anchor=\"middle\">ひとつ飛ばしの相手を消す</text><line x1=\"260\" y1=\"120\" x2=\"304\" y2=\"152\" stroke=\"#e05555\" stroke-width=\"3\" stroke-dasharray=\"6,4\" marker-end=\"url(#koku-ar)\"/><text x=\"327\" y=\"70\" font-size=\"11.5\" font-weight=\"700\" fill=\"#e05555\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"4\" paint-order=\"stroke\">木が土の養分を</text><text x=\"327\" y=\"85\" font-size=\"11.5\" font-weight=\"700\" fill=\"#e05555\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"4\" paint-order=\"stroke\">吸い取る</text><line x1=\"326\" y1=\"220\" x2=\"309\" y2=\"273\" stroke=\"#e05555\" stroke-width=\"3\" stroke-dasharray=\"6,4\" marker-end=\"url(#koku-ar)\"/><text x=\"391\" y=\"266\" font-size=\"11.5\" font-weight=\"700\" fill=\"#e05555\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"4\" paint-order=\"stroke\">土は水を汚す・</text><text x=\"391\" y=\"281\" font-size=\"11.5\" font-weight=\"700\" fill=\"#e05555\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"4\" paint-order=\"stroke\">せき止める</text><line x1=\"252\" y1=\"315\" x2=\"196\" y2=\"315\" stroke=\"#e05555\" stroke-width=\"3\" stroke-dasharray=\"6,4\" marker-end=\"url(#koku-ar)\"/><text x=\"224\" y=\"388\" font-size=\"11.5\" font-weight=\"700\" fill=\"#e05555\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"4\" paint-order=\"stroke\">水は火を</text><text x=\"224\" y=\"403\" font-size=\"11.5\" font-weight=\"700\" fill=\"#e05555\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"4\" paint-order=\"stroke\">消す</text><line x1=\"139\" y1=\"273\" x2=\"122\" y2=\"220\" stroke=\"#e05555\" stroke-width=\"3\" stroke-dasharray=\"6,4\" marker-end=\"url(#koku-ar)\"/><text x=\"57\" y=\"266\" font-size=\"11.5\" font-weight=\"700\" fill=\"#e05555\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"4\" paint-order=\"stroke\">火は金属を</text><text x=\"57\" y=\"281\" font-size=\"11.5\" font-weight=\"700\" fill=\"#e05555\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"4\" paint-order=\"stroke\">溶かす</text><line x1=\"144\" y1=\"152\" x2=\"188\" y2=\"120\" stroke=\"#e05555\" stroke-width=\"3\" stroke-dasharray=\"6,4\" marker-end=\"url(#koku-ar)\"/><text x=\"121\" y=\"70\" font-size=\"11.5\" font-weight=\"700\" fill=\"#e05555\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"4\" paint-order=\"stroke\">刃物（金）は</text><text x=\"121\" y=\"85\" font-size=\"11.5\" font-weight=\"700\" fill=\"#e05555\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"4\" paint-order=\"stroke\">木を伐る</text><circle cx=\"224\" cy=\"94\" r=\"37\" fill=\"#fff\" opacity=\"0.9\" stroke=\"#f0e3f6\" stroke-width=\"2\"/><g transform=\"translate(194,62) scale(0.5)\"><rect x=\"53\" y=\"68\" width=\"14\" height=\"34\" rx=\"6\" fill=\"#a1887f\"/><circle cx=\"36\" cy=\"58\" r=\"17\" fill=\"#66bb6a\"/><circle cx=\"84\" cy=\"58\" r=\"17\" fill=\"#66bb6a\"/><circle cx=\"60\" cy=\"46\" r=\"27\" fill=\"#4caf50\"/><circle cx=\"52\" cy=\"44\" r=\"3\" fill=\"#4a3b2a\"/><circle cx=\"68\" cy=\"44\" r=\"3\" fill=\"#4a3b2a\"/><path d=\"M53 52 Q60 57 67 52\" stroke=\"#4a3b2a\" stroke-width=\"2.5\" fill=\"none\" stroke-linecap=\"round\"/><circle cx=\"44\" cy=\"51\" r=\"4\" fill=\"#f8b4c8\" opacity=\"0.75\"/><circle cx=\"76\" cy=\"51\" r=\"4\" fill=\"#f8b4c8\" opacity=\"0.75\"/></g><text x=\"224\" y=\"125\" font-size=\"13\" font-weight=\"bold\" fill=\"#3e8e41\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"3.5\" paint-order=\"stroke\">木</text><circle cx=\"340\" cy=\"178\" r=\"37\" fill=\"#fff\" opacity=\"0.9\" stroke=\"#f0e3f6\" stroke-width=\"2\"/><g transform=\"translate(310,146) scale(0.5)\"><path d=\"M12 96 Q60 38 108 96 Z\" fill=\"#c9a227\"/><path d=\"M34 78 Q60 62 86 78\" stroke=\"#d9b545\" stroke-width=\"4\" fill=\"none\" stroke-linecap=\"round\"/><rect x=\"10\" y=\"96\" width=\"100\" height=\"8\" rx=\"4\" fill=\"#a58420\"/><path d=\"M60 50 v-16\" stroke=\"#4a8c5c\" stroke-width=\"3.5\" stroke-linecap=\"round\"/><ellipse cx=\"51\" cy=\"30\" rx=\"8\" ry=\"5\" fill=\"#66bb6a\" transform=\"rotate(-32 51 30)\"/><ellipse cx=\"69\" cy=\"30\" rx=\"8\" ry=\"5\" fill=\"#66bb6a\" transform=\"rotate(32 69 30)\"/><circle cx=\"51\" cy=\"80\" r=\"3\" fill=\"#4a3b2a\"/><circle cx=\"69\" cy=\"80\" r=\"3\" fill=\"#4a3b2a\"/><path d=\"M53 88 Q60 93 67 88\" stroke=\"#4a3b2a\" stroke-width=\"2.5\" fill=\"none\" stroke-linecap=\"round\"/><circle cx=\"43\" cy=\"87\" r=\"4\" fill=\"#f8b4c8\" opacity=\"0.75\"/><circle cx=\"77\" cy=\"87\" r=\"4\" fill=\"#f8b4c8\" opacity=\"0.75\"/></g><text x=\"340\" y=\"209\" font-size=\"13\" font-weight=\"bold\" fill=\"#a58420\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"3.5\" paint-order=\"stroke\">土</text><circle cx=\"296\" cy=\"315\" r=\"37\" fill=\"#fff\" opacity=\"0.9\" stroke=\"#f0e3f6\" stroke-width=\"2\"/><g transform=\"translate(266,283) scale(0.5)\"><path d=\"M60 12 C74 40 88 56 88 76 a28 28 0 1 1 -56 0 C32 56 46 40 60 12 Z\" fill=\"#2f8fe0\"/><ellipse cx=\"47\" cy=\"58\" rx=\"6\" ry=\"11\" fill=\"#fff\" opacity=\"0.35\" transform=\"rotate(-18 47 58)\"/><circle cx=\"52\" cy=\"74\" r=\"4\" fill=\"#fff\"/><circle cx=\"68\" cy=\"74\" r=\"4\" fill=\"#fff\"/><circle cx=\"52\" cy=\"74\" r=\"2\" fill=\"#334\"/><circle cx=\"68\" cy=\"74\" r=\"2\" fill=\"#334\"/><path d=\"M54 82 Q60 87 66 82\" stroke=\"#fff\" stroke-width=\"2.5\" fill=\"none\" stroke-linecap=\"round\"/><circle cx=\"44\" cy=\"81\" r=\"4\" fill=\"#f8b4c8\" opacity=\"0.75\"/><circle cx=\"76\" cy=\"81\" r=\"4\" fill=\"#f8b4c8\" opacity=\"0.75\"/></g><text x=\"296\" y=\"346\" font-size=\"13\" font-weight=\"bold\" fill=\"#2270b8\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"3.5\" paint-order=\"stroke\">水</text><circle cx=\"152\" cy=\"315\" r=\"37\" fill=\"#fff\" opacity=\"0.9\" stroke=\"#f0e3f6\" stroke-width=\"2\"/><g transform=\"translate(122,283) scale(0.5)\"><path transform=\"translate(12,52) scale(0.36)\" d=\"M60 10 C76 32 90 46 90 70 a30 30 0 1 1 -60 0 C30 46 44 32 60 10 Z\" fill=\"#f29db8\"/><path transform=\"translate(64,52) scale(0.36)\" d=\"M60 10 C76 32 90 46 90 70 a30 30 0 1 1 -60 0 C30 46 44 32 60 10 Z\" fill=\"#f29db8\"/><path d=\"M60 10 C76 32 90 46 90 70 a30 30 0 1 1 -60 0 C30 46 44 32 60 10 Z\" fill=\"#e8688f\"/><path d=\"M60 44 C68 54 76 62 76 75 a16 16 0 1 1 -32 0 C44 62 52 54 60 44 Z\" fill=\"#f9c8d8\"/><circle cx=\"53\" cy=\"72\" r=\"3\" fill=\"#4a3b2a\"/><circle cx=\"67\" cy=\"72\" r=\"3\" fill=\"#4a3b2a\"/><path d=\"M54 80 Q60 85 66 80\" stroke=\"#4a3b2a\" stroke-width=\"2.5\" fill=\"none\" stroke-linecap=\"round\"/><circle cx=\"45\" cy=\"79\" r=\"4\" fill=\"#f8b4c8\" opacity=\"0.75\"/><circle cx=\"75\" cy=\"79\" r=\"4\" fill=\"#f8b4c8\" opacity=\"0.75\"/></g><text x=\"152\" y=\"346\" font-size=\"13\" font-weight=\"bold\" fill=\"#d5537e\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"3.5\" paint-order=\"stroke\">火</text><circle cx=\"108\" cy=\"178\" r=\"37\" fill=\"#fff\" opacity=\"0.9\" stroke=\"#f0e3f6\" stroke-width=\"2\"/><g transform=\"translate(78,146) scale(0.5)\"><polygon points=\"60,14 94,46 60,106 26,46\" fill=\"#aab0b9\"/><polygon points=\"60,26 80,47 60,94 40,47\" fill=\"#cfd4da\"/><circle cx=\"52\" cy=\"56\" r=\"3\" fill=\"#4a3b2a\"/><circle cx=\"68\" cy=\"56\" r=\"3\" fill=\"#4a3b2a\"/><path d=\"M54 64 Q60 69 66 64\" stroke=\"#4a3b2a\" stroke-width=\"2.5\" fill=\"none\" stroke-linecap=\"round\"/><circle cx=\"44\" cy=\"63\" r=\"4\" fill=\"#f8b4c8\" opacity=\"0.75\"/><circle cx=\"76\" cy=\"63\" r=\"4\" fill=\"#f8b4c8\" opacity=\"0.75\"/><path transform=\"translate(18,22) scale(0.8)\" d=\"M0 -8 L2 -2 L8 0 L2 2 L0 8 L-2 2 L-8 0 L-2 -2 Z\" fill=\"#ffd54f\"/><path transform=\"translate(100,30) scale(0.6)\" d=\"M0 -8 L2 -2 L8 0 L2 2 L0 8 L-2 2 L-8 0 L-2 -2 Z\" fill=\"#ffd54f\"/></g><text x=\"108\" y=\"209\" font-size=\"13\" font-weight=\"bold\" fill=\"#767c85\" text-anchor=\"middle\" stroke=\"#fff\" stroke-width=\"3.5\" paint-order=\"stroke\">金</text></svg><div class=\"det-row\" style=\"line-height:1.9;\">🔴【相剋（そうこく）＝消す・抑える関係】木→土→水→火→金→木。相剋の輪は、相生の輪の「ひとつ飛ばし」の相手を並べたもの。2つの輪を重ねると五芒星（星のマーク）になります。<br><br>悪い関係という意味ではなく「ブレーキ役」。ただし多すぎる五行のブレーキは強すぎて相手を消してしまいます（くわしくは下の「⚔️多すぎる五行は相手を消す？」へ）。</div>" },
        { type: "info", head: "⚔️ 多すぎる五行は相手を消す？ ── 2人の相性での見方", body: "五行は「自分の中のバランス」だけでなく、人と人の間でも働きます。ポイントは、多すぎる五行は、相剋の矢印の先を強く消してしまうこと（これを「相乗（そうじょう）」と言います。生む方の相生と読みが同じでややこしいので、このアプリでは「消しすぎ」と呼びます）。\n\n【読み方は3ステップ】\n① 自分の五行でいちばん多いものを見る（診断カードの五行バランス）\n② 上の図で、その五行から出ている「赤い点線」の先を見る（＝自分が消しやすい五行）\n③ 相手の五行で、その「先」が少ない（0〜1個）なら要注意。自分が普通にしているだけで、相手のその部分を消してしまいやすい\n\n【たとえば】\n・金がとても多い人（正論・決断・白黒ハッキリ）× 木が少ない人 → 金は木を切るので、強い正論が相手の「新しい芽・やる気・のびのびした発想」を刈り取ってしまいがち。言い方をやわらかくするだけで解決します。\n・水がとても多い人（理屈・冷静・分析）× 火が少ない人 → 水は火を消すので、冷静なツッコミが相手の「情熱・テンション」を冷やしてしまいがち。まず「いいね！」と火に薪をくべてから話すと◎。\n・火がとても多い人（情熱・勢い）× 金が少ない人 → 熱さで相手の「きちんと決めたい気持ち」を溶かしてしまいがち。\n\n【消しすぎに気づいたら】\n悪い相性という意味ではありません。矢印は「影響が強く届く」印でもあるので、出力を2割ゆるめる・相生の矢印（緑）を使って先に相手を生かす、の2つで最高の組み合わせに変わります。また、2人とも同じ五行が少ない場合は、その五行が多い第三者に入ってもらうか、その五行の色・行動で補うとチームが安定します。" },
        { head: "🌳 木（もく）── 成長とやさしさ", body: "性質：上へ上へと伸びていく「成長」のエネルギー。向上心、素直さ、やさしさ、教育や育成の才能。\n\nたとえ：陽の木＝甲（大樹・まっすぐな大木）、陰の木＝乙（草花・しなやかで折れない）。\n\n五本能では「守備本能」＝自分や大切な人を守る力。アプリの表示色は緑です。", children: [
          { head: "🌲 大樹（甲・陽の木）──「頑固なマイペース人間」", body: "我が道を行くという個性が見え隠れするグループ。協調性が希薄で、人から指示されたり命令を受けるのが大嫌い。ひとつのことにじっくりと時間をかけて取り組む努力家です。3分類がMOONのキャラでも、マイペースというEARTH的な個性が強く出ます。" },
          { head: "🌼 草花（乙・陰の木）──「内弁慶な社交人間」", body: "「社交家・人気者・強靭・しっかり者・足腰の強い・統率力がある」という個性が見え隠れするグループ。社交人間でありながら、どこでも生きていける芯の強さを持っています。SUNのキャラの人（束縛されず自由を好む）でも、人付き合いが好きなMOONの要素が出ます。" },
        ] },
        { head: "🔥 火（か）── 情熱と表現", body: "性質：明るく燃えて周りを照らす「情熱」のエネルギー。表現力、直感、華やかさ、人を元気にする力。\n\nたとえ：陽の火＝丙（太陽・みんなを照らす）、陰の火＝丁（灯火・そっとあたためる炎）。\n\n五本能では「伝達本能」＝気持ちや情報を伝える力。アプリの表示色はピンクです。", children: [
          { head: "☀️ 太陽（丙・陽の火）──「自然体ゆとり人間」", body: "「落ち着きのない・ネアカ・活動的・無邪気・感情豊か」という個性が見え隠れするグループ。何よりも自然体を愛します。おおらかでのんびり、生まれながらに人生の楽しみ方を知っている人。名誉欲も出世欲も物欲もあまりなく、執着心もなく「なければなくても、いつか」が基本。感度のいいアンテナを持っていて、「働いても働かなくても食べるのに困らない」食道楽の人が多いです。" },
          { head: "🕯️ 灯火（丁・陰の火）──「芸術人間」", body: "「フットワークの軽さ・協調性のなさ・クリエイティブ・気分屋・情熱的・楽天的」という個性が見え隠れするグループ。デリケートでカンの鋭い芸術家タイプ。感情の起伏も激しい気難しいロマンチストで、孤独を愛したり、淋しがり屋だったり、束縛を嫌ったりします。" },
        ] },
        { head: "⛰️ 土（ど）── 安定と包容", body: "性質：どっしり受け止めて育てる「安定」のエネルギー。信頼感、継続力、面倒見のよさ、現実的な強さ。\n\nたとえ：陽の土＝戊（山・動かない大きな山）、陰の土＝己（畑・作物を育てる豊かな土）。\n\n五本能では「魅力本能」＝人を引きつける力。アプリの表示色はゴールドです。", children: [
          { head: "🏔️ 山岳（戊・陽の土）──「義理人情ボランティア人間」", body: "「面倒見がいい・どっしりとした・穏やか・頼られると嬉しい・サービス精神旺盛・パワフル」という個性が見え隠れするグループ。ボランティア精神豊富で人が良く、面倒見もいいので何かと頼られます。他人の役に立つことが最大の喜びであり使命！気前よく見えますが、それに見合った収入もあり、経済的に困ることはありません。3分類がEARTH（マイペース・損得勘定に敏感）でも、世のため人のためというMOONの要素が出ます。" },
          { head: "🌾 大地（己・陰の土）──「堅実なコツコツ人間」", body: "「愛情あふれる・粘り強さ・好感のもたれる・守り・気取らない」という個性が見え隠れするグループ。どちらかというと控えめで地味な印象の人。コツコツと努力を重ね、地に足のついた考え方をします。目に見えるものがすべての堅実派。大きな夢やロマンを追うことなく、その日その日を一生懸命生きていくタイプ。ムダ使いもせず蓄財向き。キャリアや信頼も長い時間をかけて蓄積していきます。" },
        ] },
        { head: "⚔️ 金（ごん）── 決断と美意識", body: "性質：鍛えられて鋭く輝く「決断」のエネルギー。正義感、行動力、切れ味のいい判断、美意識。\n\nたとえ：陽の金＝庚（刀・鉄、鍛えるほど強くなる）、陰の金＝辛（宝石・磨かれて輝く）。\n\n五本能では「攻撃本能」＝道を切り開く力。アプリの表示色はグレーです。", children: [
          { head: "⛏️ 鉱脈（庚・陽の金）──「直情・激しい行動人間」", body: "「全力疾走・強い意志・波乱万丈・まっすぐに突き進む・人間味あふれる・感情的」という個性が見え隠れするグループ。何事も全力投球のパワフルな人。熱く激しくスピーディーがモットー。人を騙そうとすることを知らない純粋さがあり、直情型で激しい気性ですが、竹を割ったようにサッパリしています。" },
          { head: "💎 宝石（辛・陰の金）──「優等生人間」", body: "「磨き上げられた・デリケート・優雅・華やか・品格・傷つきやすさ」という個性が見え隠れするグループ。外見は華やかで、感性の強さからストレスを感じやすい面も。常識や世間体、家柄、社風などをかなり気にする優等生タイプ。ルーズな人や時間を守らない人が大嫌い。何事に対してもクオリティの高さを求めます。" },
        ] },
        { head: "🌊 水（すい）── 知恵と柔軟さ", body: "性質：形を変えて流れ、しみこむ「知恵」のエネルギー。思考力、吸収力、柔軟さ、想像力。\n\nたとえ：陽の水＝壬（海・大河、大きく自由に流れる）、陰の水＝癸（雨・湧き水、静かにしみこむ）。\n\n五本能では「習得本能」＝学び取る力。アプリの表示色は青です。", children: [
          { head: "🌊 海洋（壬・陽の水）──「冒険人間」", body: "「大きな志を持つ・放浪・チャレンジ精神旺盛・夢とロマン・ゆったりと悠然・束縛を嫌う」という個性が見え隠れするグループ。常に破壊と創造のエネルギーに突き動かされ、常識や伝統に縛られることを極端に嫌います。常に新しいもの、夢、ロマンを求めてやまない冒険家で、行動は実にダイナミックです。" },
          { head: "💧 雨露（癸・陰の水）──「学究人間」", body: "「母性豊か・物静か・順応性・尽くすタイプ・落ち込みの激しさ・慈悲深さ」という個性が見え隠れするグループ。慈愛に満ちた母性愛と知性の人。かなりの理屈屋で、物事を論理的に考えようとする静かで理性的なタイプ。兄弟や身内への愛情が深く、子離れできない親になる可能性も。甘えん坊なタイプです。3分類が和気あいあい大好きなMOONの人でも、理屈っぽいEARTHの要素が出ます。" },
        ] },
    ...
    },
    {
      ...
      items: [
        { type: "info", head: "仕事の役割4分類ってなに？", body: "十二運のエネルギーを、ビジネスシーンにおける「4つの役割（ポジション）」に分類したものです。野球にたとえると覚えやすくなります。\n\nどんなに優秀な人でも、自分のポジション（特性）に合わない仕事をするとパフォーマンスが半減します。逆に、この4分類をベースにチームを組むと、最小の労力で最大の成果を出す「最強の組織」が完成します。\n\n【分類表（自分の本質の動物で見てください）】\n⚾ ピッチャー（新規開拓）：猿（長生）・チータ（沐浴）・黒ひょう（冠帯）\n🫴 キャッチャー（守り・フォロー）：子守熊（病）・ゾウ（死）・ひつじ（墓）\n🧢 監督（マネジメント）：ライオン（建禄）・虎（帝旺）・たぬき（衰）\n⚖️ 審判（企画・ルール）：狼（胎）・こじか（養）・ペガサス（絶）\n\n【ビジネスでの呼び名と2大別】\n・行動重視型（現場型）＝「行動したら仕事したと思う」行動派 → ⚾イノベーター（ピッチャー）＋🫴ネゴシエーター（キャッチャー）。「自分で何かをやり遂げたい」という信念を持ち、率先して事に当たるタイプ。\n・思考重視型（非現場型）＝「頭を使ったら仕事したと思う」知性派 → 🧢プロデューサー（監督）＋⚖️プランナー（審判）。自ら行動するよりも「どうすれば上手くできるか」をじっくり考えるタイプ。\n各ポジションの中に💼ビジネス版の項目を追加してあります。" },
        { head: "⚾ ピッチャー（新規営業・突破型）── 猿・チータ・黒ひょう", body: "十二運：長生（猿）・沐浴（チータ）・冠帯（黒ひょう）\n核心にある心理：「自分が先陣を切って、新しいゲームをスタートさせる！」\n\n【思考のメカニズム】\nピッチャーに属する星は「子供〜新社会人」までの、これからグングン伸びていく勢いのあるエネルギーです。最大の武器は「初速」「勢い」「華やかさ」。\n\n前例のない市場を開拓したり、初対面の顧客の懐に飛び込んで契約を勝ち取ったりする「0→1（ゼロイチ）」のフェーズで無類の強さを発揮します。細かい書類仕事やルーティンワークは苦手ですが、チームに勢いをもたらすエースストライカーです。", children: [
          { head: "💼 ビジネスでは【イノベーター】── 新規開拓・飛び込み営業", body: "12タイプ：フィーリング（猿）・スピード（チータ）・パイオニア（黒ひょう）／行動重視型（現場型）\n\n【お客さんとして】\n将来の可能性に興味を示し、メリットのアピールや強調表現で決断が速くなります。世界的に有名、高級部位、No.1など誰が見ても凄さがわかるものを好みます。速攻性を重視するので、購入を即決してもらえる準備が必要。長い説明は疎まれます。\n\n【顧客傾向】\n意思決定のスピードは速く、新規顧客として獲得しやすい。反応が速い反面、販促費が多くかかるタイプ。新規顧客としての期待値は高い。\n\n【🔍 顧客診断】あなたの顧客にピッチャー型が少ない場合 → 新規の販促をしていないサイン。\n\n【部下・チームメンバーとして】\nチャレンジ精神旺盛で、目標に向かって直線的に進みます。現場で先頭に立ち、新しい道を切り開いていく役割が得意。動きながら効果的な方法を模索し、スピード感を持って短期的な成果を挙げます。\n事例：考えるよりまずは行動。上司の指示を聞くと同時にすぐ動き出せる。" },
        ] },
        { head: "🫴 キャッチャー（ルート営業・守備型）── 子守熊・ゾウ・ひつじ", body: "十二運：病（子守熊）・死（ゾウ）・墓（ひつじ）\n核心にある心理：「確実な守りと丁寧なフォローで、ピンチを未然に防ぐ」\n\n【思考のメカニズム】\nキャッチャーに属する星は、人生の後半から完結へ向かう、非常に落ち着いたエネルギーです。最大の武器は「傾聴力」「リスク管理」「継続性」。\n\nピッチャーが取ってきた契約を、手厚いアフターフォローや顧客対応で「優良なリピーター」に育てる「1→10」のフェーズが得意です。派手さはありませんが、顧客の本音や不満をいち早く察知し、組織の解約（失点）を防ぐ、チームの文字通りの「要（かなめ）」です。", children: [
          { head: "💼 ビジネスでは【ネゴシエーター】── ルートセールス・得意先廻り", body: "12タイプ：ドリーム（子守熊）・パッション（ゾウ）・リサーチ（ひつじ）／行動重視型（現場型）\n\n【お客さんとして】\n「便利になる」「必要になる」「記念日」「◯◯のため」など理由を見つけることで決断が速まります。たまの贅沢など非日常感にも反応。根拠より、使用者レビューや制作者の裏話など身近に感じられると信頼が増します。ある程度の押しと、デメリットの提示も必要。\n\n【顧客傾向】\n意思決定のスピードはやや遅く、ワンクッションおいて決めるタイプ。定期的なコミュニケーションがないとリピートしにくい。アフターフォローが有効で、リピーターとして定着させるにはメールマガジンやニュースレターなどが欠かせません。\n\n【🔍 顧客診断】あなたの顧客にキャッチャー型が少ない場合 → アフターフォローが弱いサイン。\n\n【部下・チームメンバーとして】\n進んで現場に出て、直接目標達成に関わります。今あるものを深堀りし、ムラが生じても成果の帳尻合わせをする役割が得意。何度も繰り返し行うことでパイプを太くしながら成果を挙げます。次の一手を考えられたら行動でき、積み重ねで目標を達成していきます。\n事例：アフターフォローや誰かのサポートを徹底する、組織の進行調整役。" },
        ] },
        { head: "🧢 監督（マネジメント・リーダー業務）── ライオン・虎・たぬき", body: "十二運：建禄（ライオン）・帝旺（虎）・衰（たぬき）\n核心にある心理：「全体のパワーバランスを見極め、組織を勝利（目標達成）に導く」\n\n【思考のメカニズム】\n監督型に属する星は、「ベテラン・社長・隠居」という、組織のトップを極めた大局的なエネルギーです。最大の武器は「責任感」「統率力」「圧倒的なオーラ」。\n\nメンバーそれぞれの個性を一歩引いた視点から観察し、誰をどこに配置すれば組織が勝てるかを戦略的に考えます。プレッシャーに強く、トラブル発生時には「俺が全責任を負う」という覚悟と器を持っているため、周囲からの信頼が非常に厚いです。", children: [
          { head: "💼 ビジネスでは【プロデューサー】── 資料作成・管理", body: "12タイプ：パーフェクト（ライオン）・バランス（虎）・トラスト（たぬき）／思考重視型（非現場型）\n\n【お客さんとして】\n価値、利便性、費用対効果をトータルに考えて決断します。安定、王道など「間違いのなさ」が決定を促進。活用方法など複数プランを準備し、質問には速さより正確さで答えると信頼につながります。急かさず、面会の回数を増やして決断を待つこと。\n\n【顧客傾向】\n意思決定のスピードはやや遅いものの、じっくり納得すればリピーターとして定着しやすい。お中元・お歳暮など習慣性のある買い物が多く、購入単価・客単価ともに高い傾向。\n\n【🔍 顧客診断】あなたの顧客に監督型が少ない場合 → 習慣性のある提案をしていないサイン。\n\n【部下・チームメンバーとして】\n単独行動ではなく、組織を使って与えられた目標を達成します。全体のバランスを見極めて組織をまとめ、全体把握とリスクマネジメントを実行しながら管理・統制する役割が得意。常に全体の構想を重視し、自らはムードメーカーあるいは旗振り役に徹します。\n事例：自分一人で行動するより、部下を持ち効率よく組織を動かす指揮者。" },
        ] },
        { head: "⚖️ 審判（企画・ルールメイク型）── 狼・こじか・ペガサス", body: "十二運：胎（狼）・養（こじか）・絶（ペガサス）\n核心にある心理：「感情や利害から一歩引いて、公平なルールと仕組みでゲームを成立させる」\n\n【思考のメカニズム】\n審判に属する星は、「胎（まだ形のない構想）」「養（見守られて育つ中立さ）」「絶（枠の外にある魂）」という、しがらみゼロのゼロベースなエネルギーです。最大の武器は「客観性」「分析力」「企画力」。\n\nプレーヤーとして走り回るより、一歩引いた場所から全体を観察し、「そもそもどういうルール（仕組み）にすべきか」を考えるのが得意。新規事業の企画、社内ルールの策定、リサーチ、中立的な調整役など、「公平さと知性」が求められる場面で本領を発揮します。感情論に流されず、データと筋道で判断するチームの良心です。", children: [
          { head: "💼 ビジネスでは【プランナー】── 企画・整理整頓・意外性のあるアイデア", body: "12タイプ：インスピレーション（ペガサス）・オリジナル（狼）・セキュリティ（こじか）／思考重視型（非現場型）\n\n【お客さんとして】\n便利さや省エネなどのプラスαより、「今持っているものをよりよくできること」を重視します。商品自体の魅力より、付加価値や機能がもたらすメリットに気づくと決定が速くなります。自ら新しい価値に気づくこともあるので、考える時間を設けるのも良策。\n\n【顧客傾向】\n意思決定のスピードは遅め。大きなキャンペーンなどに誘引すれば購入につながりやすい。リピーターとして取り込むには、イベント・キャンペーン・大商談会などの実施が効果的。\n\n【🔍 顧客診断】あなたの顧客に審判型が少ない場合 → イベント・キャンペーン・大商談会等の企画がないサイン。\n\n【部下・チームメンバーとして】\n綿密な作戦を練り、経営資源（人・物・金・情報）を使って成果を挙げます。新しくユニークなオンリーワン発想で差別化を図り、現場から一歩引いた位置で知恵を出し、アイデアや作戦をまとめます。現場の流れを読み、後方からの的確な指示で前線をサポート。情報の収集や整理が得意で、要所を押さえて活用します。\n事例：計画を立てる際、どのコンテンツを誰に振るのが一番いいか考えるアイデアマン。" },
        ] },
    ...
    {
      icon: "💎", menu: "金脈", title: "金脈 ── 成金四柱推命で見るブランディングとお金の流れ",
      intro: "「自分が光るポイント」を年柱（意思）から探すブランディング術。十二運×通変星の掛け合わせで、自分だけの見せ方・稼ぎ方＝金脈が見えてきます。",
      items: [
        { type: "info", head: "金脈（成金四柱推命）ってなに？", body: "お金は人が連れてくる！「太陽が自分の輝きを自分で見られない」のと同じで、誰もが無自覚に強烈な光を放っている──という考え方のブランディング術です。「自分を知る」占いではなく、「自分が光るポイント（＝金脈・モテ覚醒ポイント）を知る」のが目的。周囲から期待されている自分を使うことで、社会や他人に見つけてもらいやすくなり、人生の難易度が下がります。\n\n見る場所はたった3つ：十二運・通変星・蔵干通変星。\n・年柱（このアプリの🧭意思）＝ 人から見られた自分、期待されている自分、初対面、ブランディング\n・月柱（💬表面）＝ コミュニケーションで出てくる自分、思考、言葉の使い方\n・日柱（🧡本質）＝ 内面、恋人や身内、最終的に受け入れてほしい自分、ファン化（沼化）\n\n【順番のイメージ】\n意識して見せていく順番：SNS・ブランディング（年柱）→ 仕事（月柱）→ 仲間・身内（日柱）\n自分で自覚しやすい順番はその逆（日柱→月柱→年柱）。だから年柱の輝きは自分では見えにくいんです。" },
        { type: "info", head: "柱の使い分け ── 命式のどこを見る？", body: "【🧭 年柱（意思）＝成金覚醒エネルギー】人とお金が寄ってくる輝き。SNSの発信、ファッション、ビジネスの肩書きに使うと認知が広がりマネタイズがイージーに。年柱の蔵干通変星は「成金シェアポイント」＝自分の輝きに集まった人が欲しがるエネルギー。\n【💬 月柱（表面）＝人に貢献するときの動き方】仕事の仕方・商品の組み立て。自然とこうなるので意識せずでOK。価値観（〜べき）、話し方、言葉選びが出る場所。\n【🧡 日柱（本質）＝自分が思う自分】ここを強みとしてビジネスしがち（泣）。願望（〜たい）、セルフイメージ。ここからズレるとストレス(笑)。最初は年柱で惹きつけ、最終的に日柱（素の自分）を開示していくことで、離れない熱狂的なファン（沼化）が生まれる。\n\n【構文ワーク】\n「私が外から認識されやすいのは（年柱）な人だが、実際の考え方は（月柱）で、許可したい／分かってほしい自分は（日柱）」\n\n【BIZBIZプロファイリング】ビジネス設計に落とすなら：\n・日柱＝自分が理想としがちな商品のゴール設定（売りたいモノを売る、になりがち）\n・月柱＝実際の実務レベル・作り込み・行動量（良いものであれば売れる、と考えがち）\n・年柱＝ブランディング・顧客が求める切り口 ← 年柱「なし」のビジネスは誰にも刺さらない。ただし日柱＆月柱を無くそうとすると自分を見失う（不幸オーラを出し続けても売れぬ、という笑）" },
        { type: "info", head: "🧮 掛け合わせの方程式 ── 年柱の通変星×十二運", body: "年柱にある「通変星」と「十二運」を掛け合わせると、自分だけの具体的なブランディング戦略が見えてきます。\n\n例①：年柱が【食神】×【胎】\n食神（楽しいこと発信）×胎（純度100%・気分屋）\n→ 戦略：「今これが楽しい！」「これめっちゃ美味しい！」と、その瞬間のピュアな初期衝動でコロコロ動きながら発信する。コツコツ同じことをやるより、「飽き性なまま、今ハマっていること」をエンタメとして見せるとモテる。\n\n例②：年柱が【印綬】×【衰】\n印綬（知性・先生）×衰（敏腕プロデューサー・大物感）\n→ 戦略：決して安売りせず、落ち着いた上品なファッションで「知的な先生・アドバイザー」のポジションを取る。相手を観察して本質的な答えをズバッと教えてあげることで、高い信頼と単価を獲得できる。\n\n※このアプリでは、意思（年柱）の十二運は診断カードに表示されています。下の一覧から自分の意思の十二運と、当てはまる通変星を探してみてください。" },
        { type: "info", head: "⚖️ 幸せバランス問題 ── 成金に振り切ると苦しくなる", body: "成金（年柱×十二運）に振り切ろうとしたら、心が苦しくなる／めっちゃ疲れる／私だと思えなくて辛い＝「幸せの紛糾者（日柱×十二運）」が続出！というお話。\n\n① 分け与えたくなっていない → まず日柱に全振り✨（自分を満たすのが先）\n② 今できるgiveレベルを超えた → 日柱に沈む（各星の「幸せチャージ」参照）\n③ 成金ポイントは“掴み”なので出オチでOK！\n④ ぶっちゃけ成金ポイントは無自覚にも出てる（諦めよう笑）\n\n【その自分は嫌われる設定】が強いと本当にそうなる！（人生は思い込み！！！）\n\n成功＝相手を喜ばせる（年柱を1番に意識）／幸せ＝理解して認める（最終は日柱の認め合い）。この2つのバランスが「お金に魂を売るのか正直問題」の答えです。" },
        { type: "info", head: "⚠️ こじらせチェック ── なぜか上手くいかない時", body: "「エネルギーダウン（覚醒前）」の状態＝他人の星を羨ましがって、無理に演じている時と定義します。ビジネスや人間関係が苦しいなら、こんな罠にハマっていないかチェック。\n\n👑 王様の星（帝旺・建禄・冠帯）を持っているのに……\n「嫌われたくないから」と、優しくおっとりした裏方（養や胎のフリ）をしていませんか？あなたは堂々と前に出て、目立って、主導権を握ることで輝く星です。\n\n🔮 オタク・教祖の星（墓・死・絶）を持っているのに……\n「もっとキラキラしなきゃ」と、無理にリア充なパーティーピープル（沐浴や冠帯のフリ）をしていませんか？あなたは1人の時間やマニアックな探求、深い精神性を語ることで人が集まる星です。\n\n【抵抗の正体】覚醒ポイントに抵抗するのは「こう見られたくない！」から。でも実際のポテンシャルは真逆（各星の「見られたくない像→実際のポテンシャル」参照）。逆に「自分こういう奴(笑)」と諦めがついたら最強🔥\n劣等感は原人のDNA（能力の低い個体が集団生活のために“わきまえる”仕組み）。そして私たちは不思議と年柱的経験を宇宙から押し付けられる(笑)──それが成金覚醒ポイントの下地になります。" },
        { type: "info", head: "🔮 裏星と陰転 ── エネルギー次第でひっくり返る", body: "十二運は6つのペア（裏星）になっていて、お互いの要素を持ち合わせています。エネルギーの状態次第でひっくり返ります（陰転・陽転）。\n\n・胎（純度100%忖度0）⇔ 帝旺（自分が1番の王様）　…甘えん坊⇔王様\n・養（どんなときも推し経由）⇔ 衰（敏腕プロデューサー）　…Bポジ⇔幅きかせたい\n・長生（すきぴにまっすぐ）⇔ 病（現実を超える妄想家）　…穏やかしっかり⇔浮世離れ独特\n・沐浴（今ココな熱いやつ）⇔ 死（本質を語る教祖様）　…本能・肉欲！⇔スピリチュアル\n・冠帯（映え命派手貴族）⇔ 墓（好きを探究オタク）　…派手派手社交界⇔地味地味引きこもり\n・建禄（努力家アイドル様）⇔ 絶（普通からの解放）　…コツコツ常識人⇔ぶっ飛び宇宙人\n\n【陰転とは】裏星っぽくなること（本来の輝きとは逆になる）。印象と言動に大きな溝ができ、自分の価値と扱いにギャップを生むので、めちゃくちゃ拗らせてる人に見える＆エネルギーを消耗します。\nただし！私たちは謎に「裏星」に憧れるので、それっぽいのを無意識にやりがち（＝常時にじみ出てる可能性が高い爆）。陰転を気にしすぎると大変なので、「なんか今、元気欲しくてやってんだな」という自覚だけでOK。\n\n【チャクラ対応（裏星ペアの意味）】\n第一チャクラ『愛されている自覚』＝養・衰／第二チャクラ『快・不快、好き嫌いが分かる』＝長生・病／第三チャクラ『肚で決める』＝沐浴・死／第四チャクラ『ハートを開く』＝冠帯・墓／第五チャクラ『コミュニケーションをとる』＝建禄・絶／第六チャクラ『直感力を信じる』＝帝旺・胎" },
        { type: "info", head: "⚡ 年柱エネルギー vs 日柱エネルギー ── SNS起業のマインド", body: "運勢エネルギー（診断カードの⚡の柱ごとの点数）を年柱と日柱で比べると、SNS起業でのマインド・プロデュースが読み解けます。\n\n・年柱 ＞＞＞ 日柱：実態（自分が思う実力）より過大に評価されてると感じやすく、不安になる。小さく魅せようとする。\n・年柱 ＜＜＜ 日柱：思うように周りから評価されていないと感じやすく、自信をなくしやすい。「自分が自分をどれだけ受け入れるか」の方が大切で、周りの自分へのイメージは否定ではないと知っておく。\n・年柱 ＝ 日柱：表裏を感じさせない、等身大の発信や自己開示がファンメイク・信頼に。\n・年柱⇔日柱の十二運キャラにギャップがある：みんなに認知される自分（年柱）を強調しつつ、セルフイメージ（日柱）へのケア・肯定が大切。1対1の場面や自己開示のシーンでは、日柱をどんどん魅せよう！" },
        { type: "info", head: "💼 タイプ別・限界界隈(笑) ── 月柱×日柱のビジネスの型", body: "BIZBIZプロファイリングの応用。月柱・日柱の十二運を年代でグループ分けすると、自分のビジネスの型（と限界笑）が見えてきます。※ネーミングは原文ママです(笑)\n\n🍼 胎・養・長生・沐浴・冠帯（若年チーム）＝お客様やサポート陣に支えられて成り立つ界隈\n月柱：かんたん＆スタートアップ＆スポット的。伴走や細やかサポートや物量は途中で気絶(笑)。自分なりの“楽”を伝えたい。\n日柱：好き、楽しい、簡単、苦しくない、疲れない、「なんか上手くいっちゃった♡」をゴールにしたい。\n\n🪖 建禄・帝旺・衰（鬼軍曹チーム）＝自分もお客様も限界コミット界隈\n月柱：やることやれ＆自分でやれ＆数字希望。期間中に形にできるまで仕上げる戦略性を持とうか？（真顔）\n日柱：「狙った」レベル・形・数字まで到達したい／させたいがゴール。“これが大人のやり方”。\n\n🧙 病・死・墓（賢者チーム）＝気持ちはあるが体がついていかない(笑)界隈\n月柱：自分が辿り着いた／信じている結論や本質を懸命に教育する。量や作業ができないので、仕組みの活用＆「本質こそシンプル」戦法。\n日柱：本質に辿り着いた良き人間に至らせたい。賢者爆誕がゴール。\n\n🛸 絶（単独競技チーム）＝“普通”ぶっ壊し屋\n月柱：脱皮させて→個性を尊重→自己愛。他の人と一緒は嫌なので、他のやり方と比べる必要なし！\n日柱：他人からの目（社会、常識）から脱皮→奇人・奇才・個性的。ありのままで人と繋がれる自分をゴールに。" },
        { type: "info", head: "🎁 グループ別・強い商品設計", body: "年柱の十二運別「こんな商品設計（ブランディング）が強いのでは？」コーナー。\n\n【胎・養】\n・無価値感（自分に価値がないと思い込んでしまう）への安心\n・誰かの力を借りることを努力不足・依存と考える思考へのケア\n\n【長生・沐浴・冠帯】\n・自分が思っている以上に人と比較する、人目を気にするところからの解放\n・人との（感覚の）違いを楽しむ、自分の感覚を肯定してあげる声かけ\n\n【建禄・帝旺】\n・頑固→変化を楽しむマインド系＆ステップ形式のコンテンツ\n・ビッグマウスや宣言系など、「観測者」をうまく使うマインドセット\n\n【衰・病・死】\n・精神的安定から幸せも成功も繋がっていく自己啓発要素を入れる\n・意識、見えない世界、神秘を用いる系\n\n【墓・絶】\n・世界や他者、自分を信頼できる「心の筋肉」をつけるマインドセット\n・批判家や粗探しから、自分も他人も“なんでもあり”精神を育てる系" },
        { head: "👑 十二運×年柱 ── 人モテポイント（全12）", body: "年柱（意思）にある十二運が、あなたの「人モテポイント」。各星に、年柱（ブランディング）・日柱（願望と幸せチャージ）・月柱（価値観と話し方）それぞれの読み方が入っています。エネルギー数はアプリの⚡エネルギーと同じ体系です。", children: [
            { head: "胎（たい）──「純度100%、忖度0」", body: "🐾 対応動物：狼／エネルギー：3／裏星：帝旺（自分が1番の王様）／ブランディング軸：マネー軸（お金・実績・成功法則を語る）\n🌟 有名人例：木村拓哉、happyちゃん（月柱）、てんちむ\n\n【特徴】\n素直。素直すぎて忖度できない（思ったことをそのまま口にする）。感情やエネルギーで動く。気分がコロコロ変わる。今を生きているので飽き性（＝多芸多才）。1人が好き。自分に素直に生きれば応援される。「できない」を口にする（できないが価値）。\n\n【💎 年柱にあるとき ── 成金覚醒ブランディング】\n感情・エネルギーで動いていく様を全力肯定＆見せびらかす。「バブみ」＝努力よりエネルギー、変化していく様を魅せる。服装をコロコロ変える、「価値（自分）探しはもう終わり！」など◎。気持ちの変化や「できない・やりたくない」の正直開示（オネスト・ブランディング）が武器。忖度できない結果の代弁者、夢を見る勇気を伝える人、何者かになれる気にさせる人。ビジュアルは素材美（肌・髪・体づくり）を磨いて推す。\n信頼の築き方：「この人は嘘をつかない」と思われること。言葉を我慢しない。お客さんにはかなり率直に。\n買われる魅力：守ってあげたい、この人→マジで熱狂的ファン化。個性の尊重。成功者のやり方をなぞっても「人と違うことをしたい」衝動こそが勝ち筋。\n商品例：エネルギー×マインド系。エネルギーワーク、意識解放系イベント。短期集中型（80%の完成度で、飽きる前に出し切る）。炎上商法系も実はイケる。\n売り方・クロージング：お勧めのノウハウというより、直感のままやるしかない(笑)\n\n【🗣️ ワンフレーズ】覚醒：「バブくいくわよ」／抵抗の声：「赤ちゃんって信頼されないよね？」\nこう見られたくない：何考えてるかわからない・怪しい → 実際のポテンシャル：神秘的・可能性のかたまり\n年柱がしっくり来ないときの隠れた願望：忖度したくない、思ったまま言いたい\n\n【⚡ エネルギーダウン（覚醒前）のサイン】\nコツコツ頑張ろうとする。一定で変えない。無価値感と戦おうとする。忖度できない自分や飽き性な自分にコンプレックスを持つ。「ちゃんとした方が良い」と思ってしまう。凄さ・価値を示したくなる（→もうやってる前提で◎）。\n\n【🧡 日柱にあるとき ── 願望・セルフイメージ】\nセルフイメージ：ピュアでかわいいの〜守られたいの〜\n幸せチャージ（沈み方）：バブ活／アレコレお願いしまくって、やってもらったら全力ニコニコ😊\nパートナーへの接し方：大切にされたいけど自分が支配したい欲もある（帝旺っぽい）。あやす！フォローは大事。1人の時間がないとストレスになるので、1人にしてあげる時間も作る。言葉に表れないことを汲み取るのが苦手なので、言葉でしっかりコミュニケーションをとる。\n\n【💬 月柱にあるとき ── 価値観・話し方】\n価値観：自分に正直であるべし＆ストレート\nパートナーへの接し方：人への興味が薄いので「好き」という気持ちになるまで時間がかかる→気持ちが追いつくまで待ってあげる。言葉や表現が忖度なし＆ストレート→こちらも忖度せず素直に接する。\n\n【💘 恋愛傾向（月柱・日柱にある場合）】〜オンリーワングループ〜\n変わり者でいたい欲、オンリーワンになりたい、天邪鬼。異性に対して辛口減点。自分のこだわり以外は相手に求めない。言葉足らずで誤解されやすい。\n\n【🤝 人間関係】得意：干渉しない、押し付けない／苦手：大人数が苦手で1人でいたい\n\n【👗 第一印象ファッション】\n素材美を活かす（ギラギラしない）。明るい・華やか・柔らかい素材（パステル、ホワイト、モヘア）。婚活ではホワイトや薄ピンク。" },
            { head: "養（よう）──「どんなときも推し経由」", body: "🐾 対応動物：こじか／エネルギー：6／裏星：衰（敏腕プロデューサー）／ブランディング軸：他人軸（信頼・愛・関係性）\n🌟 有名人例：心屋仁之助、鈴木実歩、深田恭子、森泉、明日花キララ\n\n【特徴】\n素直で無邪気。頼み事や甘え上手。自分を見てほしいという承認欲求。人柄が良い。苦手なことはしない。育てられ上手。かわいがられる。（自分が好きな）影響力がある人にどれだけ育ててもらったかを語る。自分の助けになる人に価値を与える役割。\n\n【💎 年柱にあるとき ── 成金覚醒ブランディング】\n自分が推す影響力のある人の「橋渡しポジション（Bポジ）」。苦手なことをしない。褒め褒め投稿でストレートに影響力を遠慮なく借りる。「自分に価値がない」と思う人のための自己受容のエネルギーを魅せていく。大物の下で成長していく様子を実況中継するのも◎。身内＆支持者自慢上等♡。強者と組む／育成（親）を指名する。あらゆるネタから注意を引く。ハイブランドや成功者が好む装いも似合う。\n信頼の築き方：育ててもらったストーリーをオープンに語る。ビジュアルは美人系より「かわいい・若见え」に寄せる。視座の高い人に導かれる喜びをシェア。\n買われる魅力：「私もかわいがられたい！」という自然な魅力。大きな存在との連携に乗せてもらう力。頑張ってる姿に胸アツ！\n商品例：すぐできる系の成功法則。すでにあるコンテンツや人気に乗っからせてもらう。学んだノウハウのまとめ・編集コンテンツ。足りない部分は人に任せ、コミュニティメンバーと一緒に作る形も◎。\n売り方・クロージング：影響力のある人の中で目立つ、推してもらう、ビジュ見せつけライブ\n\n【🗣️ ワンフレーズ】覚醒：「頼むよう！」／抵抗の声：「他力は自分の力と言えないよね？」\nこう見られたくない：甘えてる・依存的に見える → 実際のポテンシャル：守ってあげたい・かわいい存在\n年柱がしっくり来ないときの隠れた願望：自分を見てほしい、かわいがられたい\n\n【⚡ エネルギーダウン（覚醒前）のサイン】\n自分1人でやろうとする。自分の幸せを他者に委ねすぎる。他人と比べて自分のレベルが低いと思う。ぶりっこに思われたくない。苦手克服しようとする。\n\n【🧡 日柱にあるとき ── 願望・セルフイメージ】\nセルフイメージ：愛してるって感じさせてほしい。一緒が良い\n幸せチャージ（沈み方）：坊活／甘えん坊活動。よしよし先を確保しておく、褒められる、機嫌とってもらう\nパートナーへの接し方：愛情が釣り合ってるかを気にしすぎるので、きちんと気持ちがあると伝える。甘やかす！ほめる！これをされるほど安心する（ただし異性としてのプライドがあるので「かわいい」は控えめに）。不満があっても強く言えないので聞いてあげる。\n\n【💬 月柱にあるとき ── 価値観・話し方】\n価値観：どうやって簡単にするかな＆頼るべし\nパートナーへの接し方：どうしたら認めてもらえるか・興味を引くかを考えているかまってちゃん。嫌われることを恐れ、不安定な関係はストレスなので、安心できる言葉をかける。\n\n【💘 恋愛傾向（月柱・日柱にある場合）】〜かまってちゃんグループ〜\n愛されたい欲。1人でも自分をわかってほしい。かまってちゃん。長い付き合いになるとワガママになる。かわいげは絶対必要。人との交流が大切。\n\n【🤝 人間関係】得意：人の気持ちに敏感、人と合わせられる／苦手：慎重派で人見知り、特定の人といたい\n\n【👗 第一印象ファッション】\n好きな人に染まる、横に居て欲しくなる華やかさ（パステル、小花柄、レース、パフスリーブ）。" },
            { head: "長生（ちょうせい）──「すきぴにまっすぐ」", body: "🐾 対応動物：猿／エネルギー：9／裏星：病（現実を超える妄想家）／ブランディング軸：マネー軸\n🌟 有名人例：佐藤健、中居正広、黒柳徹子、三上悠亜\n\n【特徴】\n子どもっぽさがある。穏やかで頼れる。真面目で責任感が強い。お利口だけど、たまにクソガキ感が出る（口が悪くなる）。好き嫌いがはっきりしている。ちょっと腹黒。おっちょこちょい。好きなものをどんどん伝える。\n\n【💎 年柱にあるとき ── 成金覚醒ブランディング】\n穏やか＆頼れる感をベースに、好き嫌いをはっきりさせて魅せていく（※「嫌い」にフォーカスしすぎて敵を作らないこと）。「好き語り」をして、自分の心が穏やか＆欲が満たされていくエネルギーを魅せる。自分深掘り＆好き・価値観・世界観の発信。「シゴデキ（仕事デキる）」な自分をちょい出しする許可を出す。選んだ理由（ロジック）も添えると◎。マイワールド建築士。理想の価値観に忠実（推し命）。「自分の見つけ方」のプロを目指す。\n信頼の築き方：心から楽しんで語る姿が信頼に。ヘアメイクは知的でスマートな印象（子どもが憧れるお姉さん感）。童顔・若见えが活きる。\n買われる魅力：安心感・誠実さ。頼られたい欲が強いぶん働きすぎ注意。\n商品例：自己理解・自己肯定向け。魅力・適性・発表会的診断。「自分探し」の誘導役。誇れる世界観を使った商品、プロ意識をコンテンツ化、好きなものコレクション。\n売り方・クロージング：好きな人のやり方をパクる、好きな人・ファンに売る\n\n【🗣️ ワンフレーズ】覚醒：「好き好きよ」／抵抗の声：「正しい発言しなきゃだよね？」\nこう見られたくない：地味・固い・面白みに欠ける → 実際のポテンシャル：安心感がある・誠実・信頼できる\n年柱がしっくり来ないときの隠れた願望：叱られたくない、ずっと子どもでいたい\n\n【⚡ エネルギーダウン（覚醒前）のサイン】\n空気を読みすぎる。常に正解を選べているか気にする。平和でいたいがあまり、自分の好き嫌いを出さない。競争意識が前に出すぎて穏やかでなくなる、弱々しくなる。\n\n【🧡 日柱にあるとき ── 願望・セルフイメージ】\nセルフイメージ：自分の正解の中で優雅にいたい、好きぴ以外は極刑(笑)\n幸せチャージ（沈み方）：ヒス活／好きなものに没頭（嫌いは断罪）\nパートナーへの接し方：頼られたいプライドがありながらも、好きな人以外の世話はどうでもいい。無邪気なだけなので、好き嫌いの激しさを一緒に楽しむ。自分に無いものを持っている人と一緒にいたい（学び好き・好奇心旺盛）。\n\n【💬 月柱にあるとき ── 価値観・話し方】\n価値観：小5悪ガキ×優等生の狭間で(笑)、推し命\nパートナーへの接し方：合理的（メリット・デメリットを考える）なので、恋愛も結婚を視野に入れて考える。頼られたいので、やってくれたことにとにかく感謝する。一緒に悪ガキをする（子どもっぽいことも一緒に楽しむ）。\n\n【💘 恋愛傾向（月柱・日柱にある場合）】〜承認欲グループ〜\n好きな人に認めてほしい欲。ちょっと騙されやすい。熱しやすく冷めやすい。褒められて自信がつく。一緒にいる時間が大切（職場恋愛や学生時代からの付き合いが多い）。\n\n【🤝 人間関係】得意：人の懐に入るのが得意／苦手：あっさり淡白、人間関係のしがらみは嫌い\n\n【👗 第一印象ファッション】\nお利口さんなファッション、正統派（お姉さんへの憧れ）。パステル、黒・グレー・紺、襟付き、ボウタイブラウス。" },
            { head: "沐浴（もくよく）──「今ココな熱いやつ」", body: "🐾 対応動物：チータ／エネルギー：7／裏星：死（本質を語る教祖様）／ブランディング軸：自分軸（自己開示・世界観・気分のシェア）\n🌟 有名人例：DJ社長、キングコング西野、小田桐あさぎ（月柱）、しぃちゃん、さーりん\n\n【特徴】\nロマンチスト、自由奔放。熱いエネルギーで周囲を巻き込む。本能的なことを語る（夢・欲望・エロス）。恋愛やエロなど熱を感じるものを好む。自分が熱中できることを熱く共有する。今を生きてる。無責任くらいがいい。\n\n【💎 年柱にあるとき ── 成金覚醒ブランディング】\n本能（夢・欲・エロス）に語りかける。どんなにマニアックと思っても自分が夢中になり、沼り、そのエネルギーに巻き込む。自由やロマンを堂々と語っていく。女性性に訴えかける。「私に巻き込まれなきゃ損」前提で生きる。自分が夢中になれる（松岡修造になれる）考え方・理論・ノウハウ・商品をシェア！セルフ情熱大陸＆ノリ。波乱を起こしてモテる。煽って騒いで感動ゴール。青春（チーム・恋愛・自由・感情）。\n信頼の築き方：感受性の高さをそのままぶつける。自由そうな振る舞い。\nお客様との関わり：夢中にさせる（「夢中になることが良い！」という教育をする）。青春を疑似体験できるイベントや場所を！\n買われる魅力：もっかい感情体験をやり直したい。夢中ってかっこいい！巻き込まれたくなる汗！仲間！気分屋・ギャル感を追いたくなる。\n商品例：感情がむき出しになるコンテンツ。自分が熱中した経験のコンテンツ。数字的成果以上に仲間やチームの楽しみ方。青春時代（or現在）パッとしなかった人へのやり直し♡。✍️沐浴さんはとにかく罪悪感なく煽ってOK！ビジネスそのものより、自分の集客理論がコンテンツになるかも！\n売り方・クロージング：ライブローンチ、シェア戦争\n\n【🗣️ ワンフレーズ】覚醒：「ブチ上げてくわよ」／抵抗の声：「馬鹿に思われるよね？」\nこう見られたくない：情緒不安定・だらしない → 実際のポテンシャル：魅力的・表現豊か・色気がある\n年柱がしっくり来ないときの隠れた願望：青春の押し売りしたい、騒ぎたい、責任取りたくない\n\n【⚡ エネルギーダウン（覚醒前）のサイン】\n倫理観に縛られる。清く正しくあろうとする。清楚系を目指す。巻き込むことに責任を感じてしまう。理屈や論理に寄りすぎる、現実見過ぎ。\n\n【🧡 日柱にあるとき ── 願望・セルフイメージ】\nセルフイメージ：お金も愛も心も生活も、とにかく自由でいたい\n幸せチャージ（沈み方）：ラブ活／ふらっと旅、身体を愛でる、本能に生きる\nパートナーへの接し方：人としてより、性（男・女）として褒める。ときめき＆自由を尊重する。自分の常識を押し付けない。気分のムラはデフォルトなので責めない。同じ温度感（熱）の人に落ち着く。\n\n【💬 月柱にあるとき ── 価値観・話し方】\n価値観：自由！直感！女＆仲間として価値高くいるべし\nパートナーへの接し方：誘惑にしっかりのる。スピード感が合わないと飽きてしまう。積極的なアプローチが◎（しないと脈なしと思われる）。異性ならではの部分を褒める。理想を聞いてあげる。\n\n【💘 恋愛傾向（月柱・日柱にある場合）】〜承認欲グループ〜\nあっと驚かせたい、すごいと思われたい。恋に自由奔放。ドキドキワクワクが大事。好きになる人は目立つ人やモテる人、危なっかしい人。モテるが独身の人も多い。\n\n【🤝 人間関係】得意：自由でいたいので人にも窮屈を押し付けない／苦手：気分にムラ、長期的な関係を築くのは苦手\n\n【👗 第一印象ファッション】\n女を感じさせる露出・素材・柄。肌見せ、透け感、大柄、ドレス、海外ブランド、サテン、スリット。" },
            { head: "冠帯（かんたい）──「映え命、派手貴族（女王の星）」", body: "🐾 対応動物：黒ひょう／エネルギー：10／裏星：墓（好きを探究、気さくなオタク）／ブランディング軸：他人軸\n🌟 有名人例：富塚あすか、ヒカル、ちゃこぴ、ピカソ（月柱）、鈴木亜美\n\n【特徴】\n派手、華やか、社交的。独立心が強くプライドが高い。勝手に目立つため嫉妬されやすい。自分が前に出ていく。女性相手のビジネスが成功しやすい。しっかりと着飾る。楽しいことが好き。ポジティブ。キレイな人が好き。女性ならではの欲や憧れを覚醒させる存在。\n\n【💎 年柱にあるとき ── 成金覚醒ブランディング】\nとにかく派手になる。華やかなオンナの生き様ブランディング（見た目が華やかであるほど◎、「女前」感が大事！）。観ている人たちの欲・女性の謳歌・好みを刺激する役割へ。誰かに隠れて、ではなく自分がとにかく目立っていく。でもオープンハートで。人間関係から学んでいる自己開示。ハイブランドやZARA、艶。デビュタント＆社交。勢い（≒華）を与える。他者への信頼を鍛える。オン（仕事）は舞踏会的に着飾る。\n信頼の築き方：「いつ見てもハッピー＆爆美女でいてほしい」ファン心理を汲む(笑)。見た目もエネルギーも華やかで在る。\nお客様との関わり：地味ブスマインドをぶっ飛ばす。華やかになることを許可してあげる。ノウハウより笑顔や勇気を与える。\n買われる魅力：華やかになりたい女性心理にドーン。自分もハッピー女になれそう！爆美女はお金くれそう理論(笑)。\n商品例：自分が華やか＆前向きになるために変えた考え方や在り方コンテンツ。社交界パーティー感コンテンツ。バチクソハッピー株式会社※元気。最初の一歩系の商品＆考え方＆プロデュース。✍️事例メモ（鈴木亜美）：アップ多め、映え散らかす（微妙なショットはストーリーへ）、女前に答えるQAが大人気、男受けの色気より女受けのスタイル。\n売り方・クロージング：ライブローンチ、待ちの姿勢\n\n【🗣️ ワンフレーズ】覚醒：「派手に行くわよ」／抵抗の声：「嫉妬されたり身の丈wだよね？」\nこう見られたくない：調子に乗ってる・鼻につく → 実際のポテンシャル：華がある・あこがれの的\n年柱がしっくり来ないときの隠れた願望：映えていたい、見た目も中身もイケてたい\n\n【⚡ エネルギーダウン（覚醒前）のサイン】\n裏方になろうとする。目立つことに遠慮する。女子グループを嫌がる。プライドが邪魔してバカになれない。事務・裏方系、清貧、ほどほどの華やかさで止まってしまう。\n\n【🧡 日柱にあるとき ── 願望・セルフイメージ】\nセルフイメージ：ダサいの無理、ぜんぶ自分主導がいいな\n幸せチャージ（沈み方）：派手活／派手華やかキラキラ女子会\nパートナーへの接し方：華やかさ＆ビジュアルは必須（無意識に地味は無理）。支えてくれる人が好き。外（仕事）と内（家）のギャップがあり、家では甘えん坊になったりするので受け止める。\n\n【💬 月柱にあるとき ── 価値観・話し方】\n価値観：映え＆イケ女＆コミュ強者であるべし\nパートナーへの接し方：インパクトを残そうと考えているので、テンション・アクション・リアクションでノリに乗ってあげる（同じものを求める）。ノリを合わせないとプライドが傷つく。\n\n【💘 恋愛傾向（月柱・日柱にある場合）】〜コントロール欲グループ〜\nスマート（かっこつけ）でいたい欲。すごいと言われたい。追いかける恋。高嶺の花に恋しがち。家では甘えん坊。人前でバカにされるのはNG。\n\n【🤝 人間関係】得意：社交性抜群、楽しく人と接したい／苦手：感情が顔に出やすい、一言多い\n\n【👗 第一印象ファッション】\nキラキラ華やか、大きい柄、存在感。スパンコール、暖色、肌見せ、レース、存在感のあるトップス。" },
            { head: "建禄（けんろく）──「努力家アイドル様（王子の星）」", body: "🐾 対応動物：ライオン／エネルギー：11／裏星：絶（普通からの解放、愛の教育者）／ブランディング軸：自分軸\n🌟 有名人例：三崎優太（青汁王子）、ホリエモン、浜崎あゆみ、フワちゃん、西野＆DJ社長（月柱）、Rちゃん\n\n【特徴】\n努力家で真面目、完璧主義。いつも忙しそう。完成度ではなく「挑戦したこと」をドヤる。応援されるアイドル。正義感が強く、正論を言う。基本が重要、形から入る。信頼されやすい。\n\n【💎 年柱にあるとき ── 成金覚醒ブランディング】\n夢に向かって努力する様子を応援されるアイドル、スター。前向きな姿勢を見せておく＝辛気くさくならない、熱く語る系。「◯◯チャレンジ！」など宣言をして、そこに努力していく様子で応援される。爽やかさを持っているエネルギーの人なので、そこを忘れずに！嫌みのない努力家アイドル様。自分が積み上げてきたことをドヤァァ。「正解」の人＆圧倒的物量。無意識の“量”で圧倒。モノ申す正論を遠慮しない。「大丈夫だよ」を極める。\n信頼の築き方：すでに安定感があり信頼されやすいので、不機嫌にならないのが一番。自己犠牲や我慢をしない在り方。好感を持たれやすいので、確信犯的にかわいらしい＆柔らかめのファッションをすると絶対好評。\nお客様との関わり：もの申すサポーター。相手の積み重ねを認めてあげる。\n買われる魅力：「この人買えば間違いなし」感！自己謙遜しすぎずプリンセス。どんな分野でも自分が積み重ねてきたことは本当に素晴らしい。\n商品例：自分の積み重ねを赤裸々にシェアするコンテンツ。マニュアル、キット、「これに沿えば正解が分かります」コンテンツ。✍️自分が勝手に取り組んでいる圧倒的な物量で勝負！(笑)（例：Rちゃんの爆買い・爆食など物量系動画）\n売り方・クロージング：ライブローンチ、実践会・体験会\n\n【🗣️ ワンフレーズ】覚醒：「みんなで上にいくわよ」／抵抗の声：「甘えんなァアアアアアアアアア」\nこう見られたくない：融通がきかない・お堅い → 実際のポテンシャル：しっかりしている・頼れる\n年柱がしっくり来ないときの隠れた願望：やることやってる自分すごい、努力自慢したい\n\n【⚡ エネルギーダウン（覚醒前）のサイン】\n完成度に執着して前に踏み出せない（自責）。遊びたい欲は気持ちのブレだと思ってしまう。応援する方にまわってしまう。ハードワークすぎて辛そうになる。夢を見失ってる感。疲れてる感が出すぎる。\n\n【🧡 日柱にあるとき ── 願望・セルフイメージ】\nセルフイメージ：シゴデキでいたい、ずっと仕上がっていたい\n幸せチャージ（沈み方）：ゾ活／集中できる好きな作業を一気にやる＝ゾーンに入る\nパートナーへの接し方：自分に厳しい（自己評価が低い）ので、尊敬や素晴らしさを伝える。努力を否定せずに、努力の姿勢を褒める。肩に力が入りがちなので、肩の力を抜いてくれる人を求めている。\n\n【💬 月柱にあるとき ── 価値観・話し方】\n価値観：やることやるべし、実力主義すぎて永久修行\nパートナーへの接し方：良くも悪くも正しさを重視。正論や正義を語る人。反論したり責めたりせず、言わせておいてあげる。聞くときは笑いを添えていくスタイルで。アドリブはない方がベター。\n\n【💘 恋愛傾向（月柱・日柱にある場合）】〜コントロール欲グループ〜\n特別な存在でいたい欲。認められたい、褒められたい（適当な褒めはNG）。追いかける恋。かっこつけ（本心を見せない）。相手の意見を素直に聞けない。\n\n【🤝 人間関係】得意：信頼されやすい、礼儀正しい／苦手：周囲にも完璧を求めて厳しくなりがち\n\n【👗 第一印象ファッション】\nかわいらしい＆柔らかファッション（確信犯的にかわいらしく）、もしくはカッコいい正統派。薄ピンク、ストライプ、襟付き、シャツワンピース。" },
            { head: "帝旺（ていおう）──「自分が1番の王様（王様の星）」", body: "🐾 対応動物：虎／エネルギー：12／裏星：胎（純度100%、忖度0）／ブランディング軸：マネー軸\n🌟 有名人例：小倉優子、指原莉乃、ヒカル＆心屋仁之助（月柱）、riregram、うれしのちゃん\n\n【特徴】\n自分が1番、自分が選ぶものは良いものという圧倒的な自信（目立つ）。プライドが高い。組織をまとめる。お金や実績が好き。上から言われるのは嫌い。気を抜くと卑屈に見える・孤独になりやすい。器の大きさを出すと成長。\n\n【💎 年柱にあるとき ── 成金覚醒ブランディング】\nとにかく自分がいちばん。「自分の良い！がいちばん良いに決まってる」#強く行くわよ。「◯◯のトップ目指す」「◯◯万目指す」宣言など、ビッグマウスがぴったり！！達成できるかどうかではなく、それを言えるカリスマ性がポイント。「俺の国ってこういうこと」「俺の自国民ってこういう素晴らしい人民」アピール。どんな世界に生きていきたいか語る。自分の一番の魅力と思う部分を強調する。地味はムリかも。自信がないと着られない服やヘアメイクを着よう！才能や価値を守るKING。圧が出ているのは諦める。“仮想敵”ブランディング。他者信頼＝自分の器を広げる。\n信頼の築き方：自国民認定するとお世話焼ける。鏡は先に笑わないから、自分からワンネスやってみる。去る人にムカついても外では怒らない。\nお客様との関わり：支配的になってしまうのは仕方ない。強制ではなく、相手の自信を後押しするような接し方が◎。\n買われる魅力：自分も自信満々に振る舞いたい。圧倒的勝ち組女感を出したい。でも「人情に厚い！」で落とされたい。\n商品例：自分が自信を持てた・自己否定をやめられた経験のコンテンツ化。「自信がなきゃそんなことできないよ〜」を一緒にやってあげる。実は診断・占い・資質鑑定系も多し。✍️引き・全身ショット（圧つよいから？笑）、お金パワー、スタイル、顔面、ドヤパワー。憧れられる部分を意識的に推そう！\n売り方・クロージング：LINEやメルマガで圧をかけ続ける→ひかないように教育してからライブ\n\n【🗣️ ワンフレーズ】覚醒：「俺いってるよね」／抵抗の声：「圧強い人（自己中）って嫌われるよね」\nこう見られたくない：偉そう・圧が強い・支配的 → 実際のポテンシャル：リーダー的・堂々としている\n年柱がしっくり来ないときの隠れた願望：自分が1番＆特別\n\n【⚡ エネルギーダウン（覚醒前）のサイン】\n優しいブランディングをしようとする。控えめにいようとする。オンリーワンとか言い出す。言いたいことを言わない。自分を下げる。\n\n【🧡 日柱にあるとき ── 願望・セルフイメージ】\nセルフイメージ：1番好きって言って。意外と単純デモ気を遣って？\n幸せチャージ（沈み方）：天活／見下しまくり！天下取り活動！俺がいちばんダァアアア活動\nパートナーへの接し方：自分が1番じゃなきゃ嫌。けど1番にしてくれたら好き（単純）。「かわいい人の方がいいんでしょ」と拗ねる時もあり(笑)。不自由な状態にストレスを感じるので、お互いのスタンスを確認する。\n\n【💬 月柱にあるとき ── 価値観・話し方】\n価値観：自分全開であるべし、欲しいモノは手に入れるべし\nパートナーへの接し方：競争思考なので主導権を渡す。意見をしたい時は、相手よりもビッグになって尊敬されるレベルになる。自分のペースを崩されるとストレス。「自分の選ぶものも1番」という思考なので、すごいと伝える。\n\n【💘 恋愛傾向（月柱・日柱にある場合）】〜コントロール欲グループ〜\n主導権を握りたい欲。嫉妬や執着が強い。追いかける恋。素直に謝れない。好きな相手には尽くして世話を焼く。興味がなくなると復縁は難しい。\n\n【🤝 人間関係】得意：面倒見が良い、強いものにも堂々と立ち向かう／苦手：どストレートな物言いで敵も作りやすい\n\n【👗 第一印象ファッション】\n自分の1番の魅力を強調（地味はNG）。自信がないと着れない洋服。はっきりした色、大柄、存在感、サテンシャツ。" },
            { head: "衰（すい）──「敏腕プロデューサー（長老の星）」", body: "🐾 対応動物：たぬき／エネルギー：8／裏星：養（どんなときも推し経由）／ブランディング軸：他人軸\n🌟 有名人例：ジャニー喜多川、進撃のノア、中田敦彦、ホリエモン＆マツコ（月柱）、愛沢えみり\n\n【特徴】\n「答えを知っていそう」「教えてくれそう」と思われる大物感・見た目の説得力。影響力・観察力があり、視野が広い。無言の圧（大物感）。人の光（才能）を見つけるプロデュース力。自分の批評を述べる。実績に限らず大物感を出す。\n\n【💎 年柱にあるとき ── 成金覚醒ブランディング】\n達観している系、どっしり（見る目ありそう）系、なんか答え知ってそう。自分の批評を述べる。自信ありそう・分かってそうに振る舞う。けっこう悲観的・批判的な自分を許す（きもち明るく行こう）。ご意見番!!!!!! ずっと物申してる。成功者の素晴らしいところを我が物顔で語る。自分から出る圧は仕方ない。安っぽい格好はしない、品！老害上等！聞きたい人だけ聞いて。“内で育てる”視座高い参謀。根拠なく自信を持つ。\n信頼の築き方：自分の意見や所見を否定しないでそのまま語る。「私の言うことを聞いておけば間違いなし」感。その分、自分が経験のあるところを語る。\nお客様との関わり：プロデューサーに徹してあげる。自分の体験談を惜しみなくシェア。\n買われる魅力：この人買っておけば間違いない感。ご意見されたい。自分が分からないから形作られたい。\n商品例：グルコン（グループコンサル）やプロデュースに近いコンテンツ。プロデュース力をアピールできる動画・QAコンテンツ＆影響力ある人の良さを語ってバランスへ。実は伴走系も苦じゃない。\n売り方・クロージング：実際に会うのが強い、質疑応答あると強い\n\n【🗣️ ワンフレーズ】覚醒：「俺の話を聞け〜」／抵抗の声：「つまんないよね？」\nこう見られたくない：本音が分からない・苦労してそうに見える → 実際のポテンシャル：深い・落ち着いている・大人の魅力\n年柱がしっくり来ないときの隠れた願望：すべてに言うこときかせたい\n\n【⚡ エネルギーダウン（覚醒前）のサイン】\n余裕がなくなると笑いが消える。自分の意見を言わない。全部論破・説教したくなる。かわいがられようとしにいく。「華やかさとは違う存在感あり」の自覚なしで下手に出すぎる。パリピ目指しすぎ。\n\n【🧡 日柱にあるとき ── 願望・セルフイメージ】\nセルフイメージ：バカ嫌いだし、なりたくない！丁寧に扱えし\n幸せチャージ（沈み方）：温活／温泉に入ってる人生を。自分はよくやっていると労る、自分にケチつけない\nパートナーへの接し方：自分なりの戦略が常にあるので、動かされてあげる。馬鹿にせず、うるさがらず。心許せる相手かを見極めているので、安心を与える。\n\n【💬 月柱にあるとき ── 価値観・話し方】\n価値観：戦略性を持つべし、俺のクソバイスは最高だぜ？\nパートナーへの接し方：クソバイス（お節介アドバイス）と思っても怒らない。「自分はこういう伝え方をしてほしい」と根気強く伝える。ご意見番だけど、保守的で傷つきやすい。お互い切磋琢磨できる人が良い。\n\n【💘 恋愛傾向（月柱・日柱にある場合）】〜承認欲グループ〜\n感謝されたい欲（表に出さない）。空気を読むのがうまい。年上と話が合う。品がない人、落ち着きがない人は苦手。余計なことを言わない。\n\n【🤝 人間関係】得意：穏やか、仲裁できる、目上の人から評判がよい／苦手：本音が見えづらい、冗談が通じないことも\n\n【👗 第一印象ファッション】\n安っぽさはNG。大物感、上品さ、知性を感じさせる（黒・紺・グレー、明るい色はカチッと、上品な露出、ジャケット）。" },
            { head: "病（びょう）──「現実を超える妄想家」", body: "🐾 対応動物：子守熊／エネルギー：4／裏星：長生（すきぴにまっすぐ）／ブランディング軸：マネー軸\n🌟 有名人例：椎名林檎、松本潤、有吉弘行、タモリ、ふくれな\n\n【特徴】\n妄想力・想像力。アイデアいっぱいで体が追いつかない。ぐるぐる考えがち。浮世離れしている。ふわふわ不思議ちゃん。芸術肌。空気をよむ。理想と現実の狭間で揺れ動く。欲望に正直に自分に酔う。新しい常識を与える人。\n\n【💎 年柱にあるとき ── 成金覚醒ブランディング】\nめちゃ芸術肌っぽい、社会や現実に生きてなさそう感＝「人間やめてる感」。自分独特の世界を持っていて、キャラが浮いている。夢、芸術、イマジネーション、心や妄想力の自由（自己啓発、哲学、心理学、価値観、在り方など）。「まだまだ諦めなくていい！レッツ自己陶酔。その現実を超えていける世界が在るよ！」想像力をかき立てるメッセージを！非日常や自分好きを感じさせるファッションやヘアメイク。抑圧やタブーを代理開放。正解じゃなくても大丈夫。感情取説＆自己理解。感性・内面・共鳴を“吐く”。\n信頼の築き方：自分の現実脱出エピソードや出会い、哲学を共有していく。「自分に酔ってなきゃ書けない！言えない！」を発信＆自撮り。\nお客様との関わり：夢を見させる！リアルより可能性。正論より欲望に素直にならせて行動を後押しする。\n買われる魅力：欲望（想像・理想・妄想）が刺激される！自分の可能性を信じられる。エネルギー注入されたい！\n商品例：自分の理想を叶える系、引き寄せ系。肉体労働より意識労働、自己陶酔ツール、思考現実化エネルギー系。ダンスやアート、加工、アーティスティック◎。考え・感情を吐き出してエネルギー上昇、自己理解を深める型。✍️欲望に訴えかける。リアルを考えない、キリトリ、加工上等！\n売り方・クロージング：ライブローンチ＆個別LINE\n\n【🗣️ ワンフレーズ】覚醒：「まぼろし〜」／抵抗の声：「フワフワしてて空っぽじゃない？」\nこう見られたくない：繊細すぎ・めんどくさい → 実際のポテンシャル：感性が鋭い・美的センスが高い\n年柱がしっくり来ないときの隠れた願望：自分に酔ってたい、やること止めないでほしい\n\n【⚡ エネルギーダウン（覚醒前）のサイン】\n真面目になろうとする。地に足ついてる感を出そうとする。行動できなくて自信喪失。自分がおかしいんじゃないかと不安になる。自分の中に理屈があるのに、世間の常識やルールに左右される。\n\n【🧡 日柱にあるとき ── 願望・セルフイメージ】\nセルフイメージ：脳のシナプスの激増止まらず！マジでやると死ぬ(笑)\n幸せチャージ（沈み方）：夢活／現実逃避（一生帰ってこなくてOK※そのうち帰りたくなる）\nパートナーへの接し方：先読みする人なので、そこは諦めて何でも言ってもらえる安心を作る（あまり言葉にしないので）。「現実見ろ」とか絶対NG！不安になりやすいので払拭してあげる。定期的に1人にしてあげる。\n\n【💬 月柱にあるとき ── 価値観・話し方】\n価値観：「こうなったらいいな」がいっぱいある、感情大事\nパートナーへの接し方：好きなだけ語らせる。「もう聞いた、何が言いたいの？」は絶対にNG！「それで、それで？」と前のめりで聞いてあげる。相手の表情や声色を読んでしまうので、思ったことは伝えてあげる。\n\n【💘 恋愛傾向（月柱・日柱にある場合）】〜かまってちゃんグループ〜\n自分の考えをわかってほしい欲。妄想好きで頭フル回転（ファンタジーな妄想）。考えの言語化が苦手。大人しく優しい雰囲気。ネガティブなことも考えがち。\n\n【🤝 人間関係】得意：社交的、場の空気を明るくする／苦手：人間関係にストレスを感じやすい、1人の時間が大切、本音で付き合える人が少ない\n\n【👗 第一印象ファッション】\n非日常や自分らしさを感じさせる（量産型はNG）。不思議な柄、クセありデザイン、フリルたっぷり。" },
            { head: "死（し）──「本質を語る教祖様（教祖的存在）」", body: "🐾 対応動物：ゾウ／エネルギー：2／裏星：沐浴（今ココな熱いやつ）／ブランディング軸：自分軸\n🌟 有名人例：happyちゃん、ヒカキン、庵野秀明、マツコ・デラックス\n\n【特徴】\n本質を語る。スイッチが入ると熱い人。こだわりが強い。精神性が高く人格者。清く正しくいたい。ど正論をかます＆女前。スピリチュアル、哲学好き。時間が大事。独特な求心力がある。「どう生きる？」使命や役割を与える人。\n\n【💎 年柱にあるとき ── 成金覚醒ブランディング】\n意識やエネルギー、感覚をストイックに高めていく発信やブランディング。見えない世界を大切にしながら、浮世離れした神秘的な雰囲気が◎。世の人の「現実からの逃避先」＆見えない力を信じる力を後押ししてあげる。本質＆本気＆賢こ。正論ぶちかまし◎。みんなのメンタル管理職かも（安定感）。すべて見透かす“風”教祖。本質“っぽい感じ”で語る。身内＆信者へ説法イメージ。手放しや思想（のマニュアル）売り。ミステリアス感のあるヘアメイク、ほんのり色気、大物感。\n信頼の築き方：正論をぶちかまして刺していく。正論だけでなく、熱さや人格者を感じさせる（※教義がブレないのが大事）。\nお客様との関わり：教祖と信徒。マインドを賢くしてエネルギーを上げる。\n買われる魅力：本質好きにはたまらない。賢くなりたい、かっこよく在りたい。人間的に素晴らしくなれそう。\n商品例：マインド重視のビジネスや企画。不要なものや考えをどんどん手放して集中させる、直感＆感性を高める系（染まると気持ちイイ！）。✍️熱いド正論＆女前。意外とビジネス講座系が多い印象＝ビジネス行動の8〜9割はメンタルケアや熱量に支えられているから。「マインド」＝考え方が商品。\n売り方・クロージング：ライブローンチ、リールor切り抜き画像シェア\n\n【🗣️ ワンフレーズ】覚醒：「解放宣言」／抵抗の声：「怪しいと思われちゃうよね？」\nこう見られたくない：冷たい・無関心・淡白に見える → 実際のポテンシャル：達観している・ミステリアスで知的\n年柱がしっくり来ないときの隠れた願望：いい人でいたい、精神性優れてる自分優勝\n\n【⚡ エネルギーダウン（覚醒前）のサイン】\nリアリストになる。お金を追い求めすぎる。本質にこだわりすぎて自他共に厳しくなる。万人受けを狙いにいく。見た目から普通になろうとする。\n\n【🧡 日柱にあるとき ── 願望・セルフイメージ】\nセルフイメージ：軽やかに直感的に生きたい。私は人選ぶよ（真顔）\n幸せチャージ（沈み方）：欲活／何かに没頭、身体（枠）を捨てて欲望全開\nパートナーへの接し方：実は熱い人なので、感情をストレートに伝える（あやふやを嫌う）。嘘はNG。こちらも信じてあげる。使命感が強く、自分で何でも解決しないといけないと思いがちなので、こちらから「できること」を聞く。\n\n【💬 月柱にあるとき ── 価値観・話し方】\n価値観：徳高くいるべし、私の言うこと聞くべし\nパートナーへの接し方：人格者思考なので、こちらも誠実でいる。熱く哲学的になっても聞く（適当に聞くと見抜かれるので嘘はつかない）。相手の表情から直感的にうまくいくか見極めている。\n\n【💘 恋愛傾向（月柱・日柱にある場合）】〜オンリーワングループ〜\n本質を求めたい欲。生き方や精神的な質を求める。努力家で計算高い。見た目は穏やかでも頑固者。我が道をゆく。\n\n【🤝 人間関係】得意：仲間意識が強く、仲間には誠心誠意向き合う／苦手：敵には非情、時間にルーズな人は嫌い\n\n【👗 第一印象ファッション】\nミステリアス、ほんのり色気、大物感（黒、パープル、ワインレッド、はっきりカラー、シンプルデザイン、ベロア、サテン）。" },
            { head: "墓（ぼ）──「好きを探究、気さくなオタク」", body: "🐾 対応動物：ひつじ／エネルギー：5／裏星：冠帯（映え命、派手貴族）／ブランディング軸：他人軸\n🌟 有名人例：奥井まゆ、JUJU、ひろゆき、ヒカキン（月柱）\n\n【特徴】\n好きなことを探究するオタク。収集癖、凝り性。常に分析している。意識は低め→周囲からは安心感。お世話好きで優しい。好きなものを語るとき情報量過多＆早口。家が好き、こもっていたい。プロフェッサー感で一目置かれる。好きの探究を外に出す。\n\n【💎 年柱にあるとき ── 成金覚醒ブランディング】\n分野はなんでもOK、自分が掘りまくったものをヲタビジネスに。ヲタ早口で語る。笑いに変えることを忘れない。自分が常に何かを分析していることに気づき、その分析している様子を垂れ流す→「あなたに分析してほしい！分析聞きたい！」という人が現れてくる。自分が思う以上に周りから控えめ・地味に思われても気にしない(笑)。ヲタ道→自分版の解釈へ。言い切り＆一生モノ論法。再現性（行動）より納得性。実は浅くてもOK、興味に価値。\n信頼の築き方：研究してる様子・成果をドヤる。オリジナル・パクリ気にせず堂々と語る。実態が謎だからこそ、プライベートが見える発信も。\nお客様との関わり：人を大切にする自分を受け入れ、お客さんにも伝えていく。研究共有。\n買われる魅力：プロフェッショナル感、この人知ってそう感。実は面倒見てくれそう。なんかギャグセンある。\n商品例：ヲタを詰め込んだコンテンツ。行動より知識・意識拡大系。自己解釈＝研究を極めまくったコンテンツ、専門度高い系。✍️長文（メルマガ・本）に強い印象。投資や心理学、占いなど知識量系強し！\n売り方・クロージング：意外と文章重要／コラボライブ\n\n【🗣️ ワンフレーズ】覚醒：「出ずにいくわよ」／抵抗の声：「まだ知識が足りぬ…まだ…まだ…」\nこう見られたくない：重い・何を考えてるか分からない → 実際のポテンシャル：奥深い・知識が豊富・哲学的\n年柱がしっくり来ないときの隠れた願望：知識量で勝ちたい、お世話したい\n\n【⚡ エネルギーダウン（覚醒前）のサイン】\n「派手な方がいい」と自己否定する。無理に出かけようとする。頭で考えすぎて、愛や人間関係を忘れてしまう。自分なりの分析や批評を隠そうとする。\n\n【🧡 日柱にあるとき ── 願望・セルフイメージ】\nセルフイメージ：ひきこもってたい、常に受け身、研究していたい\n幸せチャージ（沈み方）：墓活／引きこもって地味〜に充電（それでOK）\nパートナーへの接し方：無理に外に連れ出さない。定期ヲタ活＆収集癖を否定しない。お笑いが好き。友達は多くないけど人を大切にするので、長い付き合いをしたがる。\n\n【💬 月柱にあるとき ── 価値観・話し方】\n価値観：調べまくり学びまくり考えぬくべし（爆発）\nパートナーへの接し方：自分的な結論が出るまで分析＆思考しまくるので、「考えすぎ・やりすぎ」と言わない。黙って聞く（処理が追いつかないときは笑顔で聞き流す）。遊びの恋はしない。\n\n【💘 恋愛傾向（月柱・日柱にある場合）】〜かまってちゃんグループ〜\n自分の意図を分かってほしい欲。空気を読みすぎて感情を隠す（本音を出さない）。本当は主導権を握りたい。大人数は苦手。倹約家で少しケチ。\n\n【🤝 人間関係】得意：人とすぐ打ち解ける、協調性、ユーモアあり／苦手：自分の思い通りにならないとイライラ、頑固\n\n【👗 第一印象ファッション】\n肩に力が入りすぎていない、自分のこだわりの好きな服（スウェット、ゆるワンピ、ぺたんこ靴、シンプルだけどかわいい）。" },
            { head: "絶（ぜつ）──「普通からの解放、愛の教育者（魂の星）」", body: "🐾 対応動物：ペガサス／エネルギー：1／裏星：建禄（努力家アイドル様）／ブランディング軸：自分軸\n🌟 有名人例：小田桐あさぎ、ピカソ、オノ・ヨーコ、ローランド、小坂先生\n\n【特徴】\n普通はつまらない。不安定な状態が安定。天才、変人、クセ強。過集中で多忙になったかと思えば急に休む。ダサいことが嫌い。愛の教育者。自分なりのイケてる価値観や生き方をシェアする。一箇所にとどまらない。人に共感できないので診断系ツールにハマる。\n\n【💎 年柱にあるとき ── 成金覚醒ブランディング】\n自分探求の旅をシェア。世の中や人に「ダサい」と思うことを指摘。人から理解されないことに恐れず、魂に従って生きているイケてる感。「それ誰が着る！？」系、奇抜な髪色。何かの企画やプロモーションごとにピンポイントに当てたガンガン発信系でOK。休むときは休む。人（自分が思う常識）と違うことをすると喜ばれる。みんなを「普通」から解き放つエネルギーに巻き込む人。ダサ人類へ愛の教育者。やらかし武勇伝→勇気に変換。自分が苦しいマイルール打破。まとめない＝超自己開示。\n信頼の築き方：圧倒的な自己開示！共感はされなくても、それがいつのまにか「脱・普通」の教育になる。自分探求（人間研究）を楽しんでいる様子。\nお客様との関わり：忖度しないで思ったままを言う。相手が傷ついても気にしない(笑)。\n買われる魅力：「普通で終わりたくない、でも自分が分からない」人の光。他人の作ったルールに染まれない生きづらさを、一緒に解決してくれる。\n商品例：ダサい生き方・在り方からの脱出。他人からどう思われるかより魂の声。宇宙レベルの客観性コンテンツ。手放し＆脱皮を進めて、埋没していたキャラを覚醒させるコンテンツ（まだ見ぬ自分を知りたい）。✍️あさぎさんの「絶」で守護神鑑定売れまくり！(笑)\n売り方・クロージング：ライブローンチ、質疑応答でぶっ飛んでみせる\n\n【🗣️ ワンフレーズ】覚醒：「人間やめるわよ」／抵抗の声：「てかそもそも人嫌いだし。」\nこう見られたくない：変人・ヤバい人・理解不能 → 実際のポテンシャル：天才肌・唯一無二・革命児\n年柱がしっくり来ないときの隠れた願望：みんなと同じは嫌、愛していたい\n\n【⚡ エネルギーダウン（覚醒前）のサイン】\n普通になろうとする。みんなと一緒のことをしようとする。人に共感できないのに愛したがる。無理に努力しようとする。奇抜さを否定する。\n\n【🧡 日柱にあるとき ── 願望・セルフイメージ】\nセルフイメージ：唯一無二でいたい。何かを強制されるのはムリ\n幸せチャージ（沈み方）：緊急離脱活／「あ、そうだ地球1年生だった…」\nパートナーへの接し方：人と同じと思った瞬間に萎えるので「◯◯と同じ」と言うのはNG。奇行に見えても本人は真面目なので指摘しない。エネルギー的につながっていたい寂しがりや、だけど自由も必要。\n\n【💬 月柱にあるとき ── 価値観・話し方】\n価値観：私（あなた）だから、を選ぶべし！手放すべし！\nパートナーへの接し方：人と違うところを見せつけたい。紙一重で厨二病っぽい（思春期の、大人っぽく振る舞おうとする感じ）。自信を持てるように褒めてあげる。ハプニング的な恋愛を好むので、人と違ったことをしたがる（別居婚、年の差、国際婚など）。\n\n【💘 恋愛傾向（月柱・日柱にある場合）】〜オンリーワングループ〜\nひらめきのままに生きたい欲。感性が鋭い自由人。面倒見はいいけど束縛はNG。継続力がない。気分のアップダウンがある。\n\n【🤝 人間関係】得意：上下をつけず誰にでもフレンドリー、みんな違ってみんな良い／苦手：気分屋、周りを振り回すことも、人に意見されたくない\n\n【👗 第一印象ファッション】\n「それ誰が着るの？」という奇抜・クセ強デザイン。宇宙感、ゴールド・シルバー、小物で遊ぶ、変形デザイン、ラメ。" },
        ] },
        { head: "⭐ 通変星×年柱 ── 稼ぎ方の金脈（全10）", body: "年柱にある通変星が、社会から求められるブランディング・稼ぎ方の金脈。年柱の蔵干通変星は「成金シェアポイント」＝成金の光に惹かれた人が欲しいエネルギーです。5つの分類：行動の星（正官・偏官）／自立の星（劫財・比肩）／表現の星（食神・傷官）／財の星（正財・偏財）／知性の星（印綬・偏印）。🎭タイプの仕組みの5グループ（比劫／食傷／財／官／印）と同じまとまりです。", children: [
            { head: "比肩（ひけん）── 独立・一匹狼の星", body: "🔑 キーワード：自立心、マイスタイル／分類：自立の星\n\n【特徴】\n自分の看板で生きる人。人に指図されるのが嫌いで、自分のペースを守りたい一匹狼。職人気質。\n\n【性格に出るとき（感情の通変星）】\nマイペース、職人気質、自分に厳しい、オンリーワン（建禄に近い）\n\n【💰 ビジネス・人モテの活かし方】\n「私が看板です」と堂々と前に出ること。ブレない自分軸を見せることで、ファンが「ついていきたい」と集まります。\n\n【求められていること】唯一無二、マイペース、自分に勝つ\n【成金シェアポイント（年柱の蔵干通変星にあるとき）】ひたすらマイペースを貫く、自分への全肯定" },
            { head: "劫財（ごうざい）── 組織のリーダー・大物の星", body: "🔑 キーワード：社交性、スケール感、野心／分類：自立の星\n\n【特徴】\n外見はソフトで協調性があるように見えるが、内面はものすごい野心家で計算高い。組織を動かす力がある。\n\n【性格に出るとき（感情の通変星）】\n頑固、意志が強い、勝負師、負けず嫌い、ナンバーワン（帝旺に近い）\n\n【💰 ビジネス・人モテの活かし方】\nスケールの大きな夢や目標を語ること。「この人と一緒にいれば面白い世界が見えそう」と思わせる大物感を出すのが正解。\n\n【求められていること】何が何でも手に入れる！優勝！\n【成金シェアポイント（年柱の蔵干通変星にあるとき）】理想へ勝負していく闘志、元気" },
            { head: "食神（しょくしん）── 子どもの星・おしゃべりの星", body: "🔑 キーワード：遊び心、衣食住、愛されキャラ／分類：表現の星\n\n【特徴】\n楽しいこと、美味しいものが大好き。喋る・歌う・表現することが得意。本能に忠実で、あくせく働くのは苦手。\n\n【性格に出るとき（感情の通変星）】\n楽天的、ふざける、子どもっぽい、食べるのが好き、競争は嫌\n\n【💰 ビジネス・人モテの活かし方】\n自分が「楽しい！幸せ！」と感じている姿をそのまま発信すること。人生を楽しんでいる姿そのものがコンテンツになり、人を惹きつけます。\n\n【求められていること】面白い・無駄こそ豊か\n【成金シェアポイント（年柱の蔵干通変星にあるとき）】笑いと豊かさ、純粋に楽しむ心の解放" },
            { head: "傷官（しょうかん）── 芸術家・毒舌の星", body: "🔑 キーワード：美意識、感受性、シャープな表現／分類：表現の星\n\n【特徴】\n感受性が人一倍強く、お笑いセンスや美意識が抜群。正義感が強いため、時にズバッと本質を突く毒舌（正論）が出る。\n\n【性格に出るとき（感情の通変星）】\n情緒的、繊細、直感鋭い、センスがいい、専門的、少々毒舌\n\n【💰 ビジネス・人モテの活かし方】\n妥協のない美意識や、キレのある独自の視点を表現すること。万人受けを狙うより「尖ったセンス」を出すことで熱狂的なファンがつきます。\n\n【求められていること】美しい・センス・感情\n【成金シェアポイント（年柱の蔵干通変星にあるとき）】美しさ、世界観、非言語で伝えていく感覚の解放" },
            { head: "偏財（へんざい）── 人脈・回転財の星", body: "🔑 キーワード：気配り、イベント、お金を回す／分類：財の星（お金・人脈）\n\n【特徴】\n人当たりが良く、誰とでも仲良くなれるコミュニケーションの天才。お祭り騒ぎやイベントが大好き。お金は「貯める」より「回す」タイプ。\n\n【性格に出るとき（感情の通変星）】\n気配り屋、優柔不断、ノリ良い、人たらし、貯金苦手\n\n【💰 ビジネス・人モテの活かし方】\nとにかく人を巻き込むこと。イベントを企画したり、人が集まるコミュニティを作ることで金脈が大きく跳ね上がります。\n\n【求められていること】不特定多数・世界・集団、大きな＆ハイペースなお金への信頼\n【成金シェアポイント（年柱の蔵干通変星にあるとき）】世界を信頼していくオープンハート" },
            { head: "正財（せいざい）── 着実・誠実・蓄財の星", body: "🔑 キーワード：信頼、コツコツ、マニアック／分類：財の星（お金・人脈）\n\n【特徴】\n真面目で誠実、堅実。時間をかけて信頼関係を築くのが得意。狭く深い人間関係を好み、データや細かい分析が得意なオタク気質。\n\n【性格に出るとき（感情の通変星）】\nスローペース、気にしい、真面目、お金の不安を感じやすい\n\n【💰 ビジネス・人モテの活かし方】\n「この人なら絶対に安心」という圧倒的な信頼感を出すこと。コツコツ積み上げた実績や、丁寧なサポート体制をアピールするとモテます。\n\n【求められていること】目の前の人・仲間、どんなサイズ感のお金への信頼\n【成金シェアポイント（年柱の蔵干通変星にあるとき）】目の前の人を信頼していくオープンハート" },
            { head: "偏官（へんかん）── 行動力・親分の星", body: "🔑 キーワード：スピード、義理人情、姐御肌／分類：行動の星\n\n【特徴】\n考えるより先に体が動く、圧倒的な行動力の星。じっとしているのが苦手。義理人情に厚く、頼られると断れないリーダー気質。\n\n【性格に出るとき（感情の通変星）】\nせっかち、行動主義、面倒見良い\n\n【💰 ビジネス・人モテの活かし方】\nスピーディーに成果を出していく、泥臭くもカッコいい「背中」を見せること。その突破力に周囲が惚れ込みます。\n\n【求められていること】自分に正直になる行動・本能に従う勇気\n【成金シェアポイント（年柱の蔵干通変星にあるとき）】本能に素直に生きる勇気" },
            { head: "正官（せいかん）── 品格・エリートの星", body: "🔑 キーワード：責任感、気品、ルール／分類：行動の星\n\n【特徴】\n品格があり、社会のルールやモラルを大切にする。カチッとした場所や、伝統あるものが似合う正統派。\n\n【性格に出るとき（感情の通変星）】\n真面目、責任感、正義感、礼儀正しい、保守的\n\n【💰 ビジネス・人モテの活かし方】\n「きちんとしている感（品格・清潔感）」を全面に出すこと。ちゃんとした言葉遣いやフォーマルな装いが、最高のブランディングになります。\n\n【求められていること】思い込みや常識を越えていく、行動する勇気\n【成金シェアポイント（年柱の蔵干通変星にあるとき）】自分に正直に生きる勇気" },
            { head: "偏印（へんいん）── 知的好奇心・放浪の星", body: "🔑 キーワード：自由、ニッチ、アイデア／分類：知性の星\n\n【特徴】\n占い、スピリチュアル、海外、最先端のITなど、ニッチで目新しいものが大好物。飽き性だが、ひらめきと企画力は天才的。\n\n【性格に出るとき（感情の通変星）】\n好奇心旺盛、自由、直感止まらず、人と同じは嫌\n\n【💰 ビジネス・人モテの活かし方】\n普通の人が思いつかない「マニアックなアイデア」や「旅・自由なライフスタイル」を発信すること。自由奔放さが魅力になります。\n\n【求められていること】自由・変化・枠外し・未来\n【成金シェアポイント（年柱の蔵干通変星にあるとき）】枠を外す、自由をくれそう" },
            { head: "印綬（いんじゅ）── 学問・母親の星", body: "🔑 キーワード：知性、教える、おっとり／分類：知性の星\n\n【特徴】\n勉強が大好きで、知識を深く探究するインテリの星。優しくおっとりしていて、人に何かを教えるのが得意。\n\n【性格に出るとき（感情の通変星）】\n学びたい、バカが嫌い、思考止まらず（衰に近い）\n\n【💰 ビジネス・人モテの活かし方】\n先生ポジション（教科書・カリキュラムを作る側）に立つこと。分かりやすく知識を噛み砕いて教えることで、多くの生徒（ファン）に恵まれます。\n\n【求められていること】答え・決定・安心\n【成金シェアポイント（年柱の蔵干通変星にあるとき）】答えを与える、安心をくれそう" },
        ] },
      ]
    },
  ];
  ...
  const FORBES_NOTES_W = {
    "2026": "イーロン・マスクが首位を盤石にした年。生成AIが投資の主役となり、AI関連の富豪が資産を大きく伸ばした。",
    "2025": "マスクが首位を維持。生成AIブームが本格化し、AI・半導体関連の富豪の資産が膨張した年。",
    "2024": "ラグジュアリー市場の好調でベルナール・アルノー（LVMH）が世界首位。AI・半導体ブーム（エヌビディア急騰）がテック富豪を再び押し上げ始めた年。",
    "2023": "高級ブランドの記録的業績で、アルノーがマスクを抜き初の年間世界1位。前年までのテック株が調整した年。",
    "2022": "テスラ株の歴史的高値でイーロン・マスクが初の世界1位。ロシアのウクライナ侵攻で資源価格が乱高下した年でもある。",
    "2021": "コロナ禍の金融緩和で株価が歴史的高値となり、富豪の資産が史上最大の伸び。ベゾスが4年連続首位、マスクがテスラ株の急騰で一気に2位へ。",
    "2020": "コロナ初期の混乱で株価が乱高下。ベゾスが3年連続首位、LVMHのアルノーが初の3位に食い込んだ。",
    "2019": "米中貿易摩擦の激化と世界的な株価調整で、多くの富豪が資産を減らした年。ベゾスが2年連続首位。",
    "2018": "アマゾン株の急騰で、ベゾスがゲイツを抜き初の世界首位。テック長者がランキング上位を占める時代が本格化した。",
    "2017": "ITテック企業の躍進が加速し、ゲイツが4年連続首位、ベゾスが初のトップ3入り。世界の富豪数が初めて2,000人を突破した年。",
    "2016": "原油安と世界的な株式市場の変動で、上位陣も資産を減らした年。ゲイツが3年連続首位、ザッカーバーグが31歳で初のトップ10入り。",
    "2015": "IT企業の躍進が加速し、ゲイツが2年連続首位。当時30歳のザッカーバーグが躍進し、ウォルトン一族（ウォルマート）が上位を独占。原油安で資源系の富豪が後退した。",
    "2014": "ビル・ゲイツが4年ぶりにカルロス・スリムから首位を奪還。米国株の強気相場がIT富豪を押し上げ、ザッカーバーグが株価V字回復で29歳にしてトップ20目前へ急浮上した。",
    "2013": "カルロス・スリムが4年連続で世界首位を維持。ZARAのアマンシオ・オルテガがバフェットを抜き初の世界3位へ。リーマン・ショック後の株価回復で、富豪の資産総額が過去最高を更新し始めた年。",
  };
  const FORBES_NOTES_J = {
    "2026": "柳井正と孫正義が逆転し、孫正義が日本首位に。AI投資の波がソフトバンクを押し上げ、日本のランキングを動かした年。",
    "2025": "柳井正が首位、孫正義が2位（翌2026年に逆転）。AIブームでソフトバンク関連が再評価され始めた年。",
    "2024": "半導体需要でディスコの関家一族がトップ5へ躍進。柳井正が首位を継続し、日経平均が34年ぶりに史上最高値を更新した年。",
    "2023": "急速な円安の中でも柳井正が首位を独走。キーエンスの滝崎武光が孫正義を抜いて2位に上がった。",
    "2022": "株価変動で柳井正が首位に返り咲き。急速な円安（ドル建て資産の目減り）が日本の富豪全体に逆風となった年。",
    "2021": "ソフトバンク株の暴騰で孫正義が首位に返り咲き。日経平均がバブル後初の3万円を回復した年。",
    "2020": "WeWork投資の損失などで孫正義が資産を減らし、柳井正が首位に。コロナ初期の混乱の年。",
    "2019": "柳井正が孫正義を抜いて首位に返り咲き。米中摩擦による株価調整が日本勢の資産にも波及した。",
    "2018": "ソフトバンクのビジョン・ファンドによる世界的IT投資戦略で、孫正義が首位を維持した年。",
    "2017": "孫正義が柳井正から首位を奪還。10兆円規模のビジョン・ファンド構想が動き出した年。",
    "2016": "株安・円高で柳井正が2年連続首位。上位陣の資産も目減りした年。",
    "2015": "柳井正が孫正義を抜き首位に返り咲き。『モンスト』でミクシィがV字回復し、滝崎武光・安田隆夫らカリスマ創業者が経営の第一線を退いた節目の年。",
    "2014": "ソフトバンクの米スプリント買収やアリババ上場観測で、孫正義が柳井正を抜き首位に。コロプラ・グリーなどスマホゲーム黎明期の若手IT富豪が上位に食い込んだ。",
    "2013": "ユニクロの柳井正が首位を堅持（翌年孫正義と逆転する前夜）。アベノミクス初期の株高が始まり、スマホゲーム関連の富豪が主役に躍り出る直前の時期。",
  };
  ...
  function renderLibrary() {
    ...
    // フォーブスの年タブを開いたときだけ、その年の要約を最上部に1回表示
    const fbm = libraryGenreFilter.match(/^フォーブス(世界|日本)(\d{4})$/);
    if (fbm) {
      const note = (fbm[1] === "世界" ? FORBES_NOTES_W : FORBES_NOTES_J)[fbm[2]];
