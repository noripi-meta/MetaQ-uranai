...
(function () {
  ...
  const KAISETSU_SECTIONS = [
    ...
    {
      icon: "🕰️", menu: "時間の2分類", title: "時間の2分類 ── 未来展望型と過去回想型",
      intro: "「これからの話」にワクワクする人と、「これまでの実績」を信頼する人。視点の向きの違いです。",
      items: [
        { type: "info", head: "時間の2分類ってなに？", body: "時間のベクトル（視点）がどこを向いているかを表すのが「未来展望型」と「過去回想型」の2分類です。十二運が持つ「魂の年齢（エネルギーの性質）」と深く連動しています。\n\n「未来の可能性」にワクワクする人と、「過去のデータと経験」を重んじる人。この時間軸のズレを理解すると、すれ違いの理由が驚くほど明確になります。\n\n【分類表（自分の本質の動物で見てください）】\n🚀 未来展望型：狼（胎）・こじか（養）・猿（長生）・チータ（沐浴）・黒ひょう（冠帯）・ペガサス（絶）\n⏳ 過去回想型：ライオン（建禄）・虎（帝旺）・たぬき（衰）・子守熊（病）・ゾウ（死）・ひつじ（墓）\n\n🧭「思考の2分類」（目標志向／状況対応）と掛け合わせて読むと、その人の考え方がさらに立体的にわかります。" },
  ...
  function kaisetsuItemHtml(it) {
    ...
    const bodyHtml = it.body ? `<div class="det-row" style="line-height:1.9; white-space:pre-wrap;">${escapeHtml(it.body)}</div>` : "";
