...
(function () {
  ...
  const LIBRARY_PEOPLE = [
    ...
    { genre: "フォーブス日本2026", name: "関家一族（関家一馬）", date: "", desc: "5位 ディスコ｜半導体製造用の切削・研磨装置で世界シェアの大半を握る。" },
    ...
    { genre: "フォーブス日本2026", name: "伊藤兄弟（伊藤雅俊の遺族）", date: "", desc: "11位 セブン＆アイHD｜イトーヨーカドーやセブンを築いた伊藤雅俊氏の資産を継承。" },
    ...
    { genre: "フォーブス日本2026", name: "小川一族（小川賢太郎）", date: "", desc: "18位 ゼンショーHD｜「すき家」等を展開する外食日本一のチェーン。" },
    { genre: "フォーブス日本2026", name: "内山一族（内山庄三郎）", date: "", desc: "19位 レーザーテック｜半導体マスク欠陥検査装置で世界シェア100%の一族。" },
    { genre: "フォーブス日本2026", name: "森一族（森稔の遺族）", date: "", desc: "20位 森ビル｜六本木ヒルズ・麻布台ヒルズなど都心の街づくりを行う一族。" },
    { genre: "フォーブス日本2026", name: "永守 重信", date: "1944/08/28", desc: "21位 ニデック（日本電産）｜世界的モーター大手ニデックの創業者。M&Aの達人。" },
    { genre: "フォーブス日本2026", name: "土屋嘉雄一族", date: "", desc: "22位 ワークマン／カインズ｜ベイシアグループ創業者。「ワークマン」を一般向けに大ヒット。" },
    { genre: "フォーブス日本2026", name: "元谷一族（元谷外志雄）", date: "", desc: "23位 アパグループ｜日本最大級のホテルチェーン「APAホテル」を築いた。" },
    ...
    { genre: "フォーブス日本2026", name: "石原一族（石原昌幸）", date: "", desc: "30位 平和｜パチンコ・パチスロ大手「平和」の創業者一族。" },
