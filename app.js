...
(function () {
  ...
  const KAISETSU_SECTIONS = [
    ...
    {
      icon: "💎", menu: "億モテ成金", title: "億モテ成金四柱推命 ── 年柱で見るブランディングと金脈",
      intro: "「自分が光るポイント」を年柱（意思）から探すブランディング術。十二運×通変星の掛け合わせで、自分だけの見せ方・稼ぎ方が見えてきます。",
      items: [
        { type: "info", head: "億モテ成金四柱推命ってなに？", body: "「自分を知る」ための占いではなく、「自分が光るポイントを知る」ためのブランディング術です。周囲から期待されている自分（＝モテ覚醒ポイント）を使うことで、社会や他人に自分を見つけてもらいやすくなり、人生の難易度が下がる、という考え方。ビジネスの成功法則だけでなく、自分の幸せも一緒に手に入れることを目的としています。\n\nこのメソッドの最大の特徴は、基本を「年柱」で見ること（このアプリでは🧭意思の柱です）。\n・年柱（意思）＝ 人から見られた自分、周囲から期待されている自分、初対面、ブランディング\n・月柱（表面）＝ コミュニケーションをとる時に出てくる自分、思考、言葉の使い方（顔見知り以上）\n・日柱（本質）＝ 内面、本質、恋人や身内、最終的に受け入れてほしい自分、ファン化（沼化）\n\n【柱の使い分け】\n🧭 年柱の星 → SNSの発信、ファッション、ビジネスの肩書きに使うと認知が広がりマネタイズがイージーに。\n💬 月柱の星 → 実際の仕事の進め方、商品設計、サービス提供時のコミュニケーションに使うとお互いストレスなし。\n🧡 日柱の星 → 最初は年柱（外向きの顔）で惹きつけ、最終的に日柱（素の自分）を開示していくことで、離れない熱狂的なファン（沼化）が生まれる。" },
        ...
        { head: "👑 十二運×年柱 ── 人モテポイント（全12）", body: "年柱（意思）にある十二運が、あなたの「人モテポイント」。エネルギー数はアプリの⚡エネルギーと同じ体系です。", children: [
            { head: "胎（たい）──「純度100%、忖度0」", body: "🐾 対応動物：狼／エネルギー：3\n\n【特徴】\n素直。素直すぎて忖度できない（思ったことをそのまま口にする）。感情やエネルギーで動く。気分がコロコロ変わる。今を生きているので飽き性（＝多芸多才）。\n\n【⚡ エネルギーダウン（覚醒前）のサイン】\nコツコツ頑張ろうとする。一定で変えない。無価値感と戦おうとする。忖度できない自分や飽き性な自分にコンプレックスを持つ。\n\n【💘 恋愛傾向（月柱・日柱にある場合）】〜オンリーワングループ〜\n変わり者でいたい欲、オンリーワンになりたい、天邪鬼。異性に対して辛口減点。自分のこだわり以外は相手に求めない。言葉足らずで誤解されやすい。\n\n【👗 第一印象ファッション】\n素材美を活かす（ギラギラしない）。明るい・華やか・柔らかい素材（パステル、ホワイト、モヘア）。婚活ではホワイトや薄ピンク。" },
            { head: "養（よう）──「どんなときも推し経由」", body: "🐾 対応動物：こじか／エネルギー：6\n\n【特徴】\n素直で無邪気。頼み事や甘え上手。自分を見てほしいという承認欲求。人柄が良い。苦手なことはしない。育てられ上手。かわいがられる。\n\n【⚡ エネルギーダウン（覚醒前）のサイン】\n自分1人でやろうとする。自分の幸せを他者に委ねすぎる。他人と比べて自分のレベルが低いと思う。ぶりっこに思われたくない。\n\n【💘 恋愛傾向（月柱・日柱にある場合）】〜かまってちゃんグループ〜\n愛されたい欲。1人でも自分をわかってほしい。かまってちゃん。長い付き合いになるとワガママになる。かわいげは絶対必要。人との交流が大切。\n\n【👗 第一印象ファッション】\n好きな人に染まる、横に居て欲しくなる華やかさ（パステル、小花柄、レース、パフスリーブ）。" },
            { head: "長生（ちょうせい）──「すきぴにまっすぐ」", body: "🐾 対応動物：猿／エネルギー：9\n\n【特徴】\n子どもっぽさがある。穏やかで頼れる。真面目で責任感が強い。お利口だけど、たまにクソガキ感が出る（口が悪くなる）。好き嫌いがはっきりしている。\n\n【⚡ エネルギーダウン（覚醒前）のサイン】\n空気を読みすぎる。常に正解を選べているか気にする。平和でいたいがあまり、自分の好き嫌いを出さない。\n\n【💘 恋愛傾向（月柱・日柱にある場合）】〜承認欲グループ〜\n好きな人に認めてほしい欲。ちょっと騙されやすい。熱しやすく冷めやすい。褒められて自信がつく。一緒にいる時間が大切（職場恋愛や学生時代からの付き合いが多い）。\n\n【👗 第一印象ファッション】\nお利口さんなファッション、正統派（お姉さんへの憧れ）。パステル、黒・グレー・紺、襟付き、ボウタイブラウス。" },
            { head: "沐浴（もくよく）──「今ココな熱いやつ」", body: "🐾 対応動物：チータ／エネルギー：7\n\n【特徴】\nロマンチスト、自由奔放。熱いエネルギーで周囲を巻き込む。本能的なことを語る（夢・欲望・エロス）。自分が熱中できることを熱く共有する。\n\n【⚡ エネルギーダウン（覚醒前）のサイン】\n倫理観に縛られる。清く正しくあろうとする。清楚系を目指す。巻き込むことに責任を感じてしまう。\n\n【💘 恋愛傾向（月柱・日柱にある場合）】〜承認欲グループ〜\nあっと驚かせたい、すごいと思われたい。恋に自由奔放。ドキドキワクワクが大事。好きになる人は目立つ人やモテる人、危なっかしい人。モテるが独身の人も多い。\n\n【👗 第一印象ファッション】\n女を感じさせる露出・素材・柄。肌見せ、透け感、大柄、ドレス、海外ブランド、サテン、スリット。" },
            { head: "冠帯（かんたい）──「映え命、派手貴族（女王の星）」", body: "🐾 対応動物：黒ひょう／エネルギー：10\n\n【特徴】\n派手、華やか、社交的。独立心が強くプライドが高い。勝手に目立つため嫉妬されやすい。女性相手のビジネスが成功しやすい。ポジティブ。\n\n【⚡ エネルギーダウン（覚醒前）のサイン】\n裏方になろうとする。目立つことに遠慮する。女子グループを嫌がる。プライドが邪魔してバカになれない。\n\n【💘 恋愛傾向（月柱・日柱にある場合）】〜コントロール欲グループ〜\nスマート（かっこつけ）でいたい欲。すごいと言われたい。追いかける恋。高嶺の花に恋しがち。家では甘えん坊。人前でバカにされるのはNG。\n\n【👗 第一印象ファッション】\nキラキラ華やか、大きい柄、存在感。スパンコール、暖色、肌見せ、レース、存在感のあるトップス。" },
            { head: "建禄（けんろく）──「努力家アイドル様（王子の星）」", body: "🐾 対応動物：ライオン／エネルギー：11\n\n【特徴】\n努力家で真面目、完璧主義。いつも忙しそう。完成度ではなく「挑戦したこと」をドヤる。応援されるアイドル。正義感が強く、正論を言う。\n\n【⚡ エネルギーダウン（覚醒前）のサイン】\n完成度に執着して前に踏み出せない（自責）。遊びたい欲は気持ちのブレだと思ってしまう。応援する方にまわる。疲れてる感が出すぎる。\n\n【💘 恋愛傾向（月柱・日柱にある場合）】〜コントロール欲グループ〜\n特別な存在でいたい欲。認められたい、褒められたい（適当な褒めはNG）。追いかける恋。かっこつけ（本心を見せない）。相手の意見を素直に聞けない。\n\n【👗 第一印象ファッション】\nかわいらしい＆柔らかファッション（確信犯的にかわいらしく）、もしくはカッコいい正統派。薄ピンク、ストライプ、襟付き、シャツワンピース。" },
            { head: "帝旺（ていおう）──「自分が1番の王様（王様の星）」", body: "🐾 対応動物：虎／エネルギー：12\n\n【特徴】\n自分が1番、自分が選ぶものは良いものという圧倒的な自信（目立つ）。プライドが高い。組織をまとめる。お金や実績が好き。上から言われるのは嫌い。\n\n【⚡ エネルギーダウン（覚醒前）のサイン】\n優しいブランディングをしようとする。控えめにいようとする。オンリーワンとか言い出す。言いたいことを言わない。\n\n【💘 恋愛傾向（月柱・日柱にある場合）】〜コントロール欲グループ〜\n主導権を握りたい欲。嫉妬や執着が強い。追いかける恋。素直に謝れない。好きな相手には尽くして世話を焼く。興味がなくなると復縁は難しい。\n\n【👗 第一印象ファッション】\n自分の1番の魅力を強調（地味はNG）。自信がないと着れない洋服。はっきりした色、大柄、存在感、サテンシャツ。" },
            { head: "衰（すい）──「敏腕プロデューサー（長老の星）」", body: "🐾 対応動物：たぬき／エネルギー：8\n\n【特徴】\n「答えを知っていそう」「教えてくれそう」と思われる大物感・見た目の説得力。影響力・観察力があり、視野が広い。人の光（才能）を見つけるプロデュース力。\n\n【⚡ エネルギーダウン（覚醒前）のサイン】\n余裕がなくなると笑いが消える。自分の意見を言わない。全部論破・説教したくなる。かわいがられようとしにいく。\n\n【💘 恋愛傾向（月柱・日柱にある場合）】〜承認欲グループ〜\n感謝されたい欲（表に出さない）。空気を読むのがうまい。年上と話が合う。品がない人、落ち着きがない人は苦手。余計なことを言わない。\n\n【👗 第一印象ファッション】\n安っぽさはNG。大物感、上品さ、知性を感じさせる（黒・紺・グレー、明るい色はカチッと、上品な露出、ジャケット）。" },
            { head: "病（びょう）──「現実を超える妄想家」", body: "🐾 対応動物：子守熊／エネルギー：4\n\n【特徴】\n妄想力・想像力。アイデアいっぱいで体が追いつかない。ふわふわ不思議ちゃん。芸術肌。理想と現実の狭間で揺れ動く。新しい常識を与える人。\n\n【⚡ エネルギーダウン（覚醒前）のサイン】\n真面目になろうとする。地に足ついてる感を出そうとする。行動できなくて自信喪失。自分がおかしいんじゃないかと不安になる。\n\n【💘 恋愛傾向（月柱・日柱にある場合）】〜かまってちゃんグループ〜\n自分の考えをわかってほしい欲。妄想好きで頭フル回転（ファンタジーな妄想）。考えの言語化が苦手。大人しく優しい雰囲気。ネガティブなことも考えがち。\n\n【👗 第一印象ファッション】\n非日常や自分らしさを感じさせる（量産型はNG）。不思議な柄、クセありデザイン、フリルたっぷり。" },
            { head: "死（し）──「本質を語る教祖様（教祖的存在）」", body: "🐾 対応動物：ゾウ／エネルギー：2\n\n【特徴】\n本質を語る。スイッチが入ると熱い人。こだわりが強い。精神性が高く人格者。ど正論をかます。スピリチュアル、哲学好き。独特な求心力がある。\n\n【⚡ エネルギーダウン（覚醒前）のサイン】\nリアリストになる。お金を追い求めすぎる。本質にこだわりすぎて自他共に厳しくなる。万人受けを狙いにいく。普通になろうとする。\n\n【💘 恋愛傾向（月柱・日柱にある場合）】〜オンリーワングループ〜\n本質を求めたい欲。生き方や精神的な質を求める。努力家で計算高い。見た目は穏やかでも頑固者。我が道をゆく。\n\n【👗 第一印象ファッション】\nミステリアス、ほんのり色気、大物感（黒、パープル、ワインレッド、はっきりカラー、シンプルデザイン、ベロア、サテン）。" },
            { head: "墓（ぼ）──「好きを探究、気さくなオタク」", body: "🐾 対応動物：ひつじ／エネルギー：5\n\n【特徴】\n好きなことを探究するオタク。収集癖、凝り性。常に分析している。家が好き、こもっていたい。プロフェッサー感で一目置かれる。お世話好きで優しい。\n\n【⚡ エネルギーダウン（覚醒前）のサイン】\n「派手な方がいい」と自己否定する。無理に出かけようとする。頭で考えすぎて、愛や人間関係を忘れてしまう。\n\n【💘 恋愛傾向（月柱・日柱にある場合）】〜かまってちゃんグループ〜\n自分の意図を分かってほしい欲。空気を読みすぎて感情を隠す（本音を出さない）。本当は主導権を握りたい。大人数は苦手。倹約家で少しケチ。\n\n【👗 第一印象ファッション】\n肩に力が入りすぎていない、自分のこだわりの好きな服（スウェット、ゆるワンピ、ぺたんこ靴、シンプルだけどかわいい）。" },
            { head: "絶（ぜつ）──「普通からの解放、愛の教育者（魂の星）」", body: "🐾 対応動物：ペガサス／エネルギー：1\n\n【特徴】\n普通はつまらない。不安定な状態が安定。天才、変人、クセ強。過集中で多忙になったかと思えば急に休む。ダサいことが嫌い。自分なりのイケてる価値観をシェアする。一箇所にとどまらない。\n\n【⚡ エネルギーダウン（覚醒前）のサイン】\n普通になろうとする。みんなと一緒のことをしようとする。人に共感できないのに愛したがる。無理に努力しようとする。\n\n【💘 恋愛傾向（月柱・日柱にある場合）】〜オンリーワングループ〜\nひらめきのままに生きたい欲。感性が鋭い自由人。面倒見はいいけど束縛はNG。継続力がない。気分のアップダウンがある。ハプニング的な恋愛（別居婚、年の差、国際婚など）を好む。\n\n【👗 第一印象ファッション】\n「それ誰が着るの？」という奇抜・クセ強デザイン。宇宙感、ゴールド・シルバー、小物で遊ぶ、変形デザイン、ラメ。" },
        ] },
        { head: "⭐ 通変星×年柱 ── 稼ぎ方の金脈（全10）", body: "年柱にある通変星が、社会から求められるブランディング・稼ぎ方の金脈。🎭タイプの仕組みにある5グループ（比劫／食傷／財／官／印）は、この10個を2つずつまとめたものです（比肩＋劫財＝比劫、食神＋傷官＝食傷、偏財＋正財＝財、偏官＋正官＝官、偏印＋印綬＝印）。", children: [
            { head: "比肩（ひけん）── 独立・一匹狼の星", body: "🔑 キーワード：自立心、マイスタイル\n\n【特徴】\n自分の看板で生きる人。人に指図されるのが嫌いで、自分のペースを守りたい一匹狼。職人気質。\n\n【💰 ビジネス・人モテの活かし方】\n「私が看板です」と堂々と前に出ること。ブレない自分軸を見せることで、ファンが「ついていきたい」と集まります。" },
            { head: "劫財（ごうざい）── 組織のリーダー・大物の星", body: "🔑 キーワード：社交性、スケール感、野心\n\n【特徴】\n外見はソフトで協調性があるように見えるが、内面はものすごい野心家で計算高い。組織を動かす力がある。\n\n【💰 ビジネス・人モテの活かし方】\nスケールの大きな夢や目標を語ること。「この人と一緒にいれば面白い世界が見えそう」と思わせる大物感を出すのが正解。" },
            { head: "食神（しょくしん）── 子どもの星・おしゃべりの星", body: "🔑 キーワード：遊び心、衣食住、愛されキャラ\n\n【特徴】\n楽しいこと、美味しいものが大好き。喋る・歌う・表現することが得意。本能に忠実で、あくせく働くのは苦手。\n\n【💰 ビジネス・人モテの活かし方】\n自分が「楽しい！幸せ！」と感じている姿をそのまま発信すること。人生を楽しんでいる姿そのものがコンテンツになり、人を惹きつけます。" },
            { head: "傷官（しょうかん）── 芸術家・毒舌の星", body: "🔑 キーワード：美意識、感受性、シャープな表現\n\n【特徴】\n感受性が人一倍強く、お笑いセンスや美意識が抜群。正義感が強いため、時にズバッと本質を突く毒舌（正論）が出る。\n\n【💰 ビジネス・人モテの活かし方】\n妥協のない美意識や、キレのある独自の視点を表現すること。万人受けを狙うより「尖ったセンス」を出すことで熱狂的なファンがつきます。" },
            { head: "偏財（へんざい）── 人脈・回転財の星", body: "🔑 キーワード：気配り、イベント、お金を回す\n\n【特徴】\n人当たりが良く、誰とでも仲良くなれるコミュニケーションの天才。お祭り騒ぎやイベントが大好き。お金は「貯める」より「回す」タイプ。\n\n【💰 ビジネス・人モテの活かし方】\nとにかく人を巻き込むこと。イベントを企画したり、人が集まるコミュニティを作ることで金脈が大きく跳ね上がります。" },
            { head: "正財（せいざい）── 着実・誠実・蓄財の星", body: "🔑 キーワード：信頼、コツコツ、マニアック\n\n【特徴】\n真面目で誠実、堅実。時間をかけて信頼関係を築くのが得意。狭く深い人間関係を好み、データや細かい分析が得意なオタク気質。\n\n【💰 ビジネス・人モテの活かし方】\n「この人なら絶対に安心」という圧倒的な信頼感を出すこと。コツコツ積み上げた実績や、丁寧なサポート体制をアピールするとモテます。" },
            { head: "偏官（へんかん）── 行動力・親分の星", body: "🔑 キーワード：スピード、義理人情、姐御肌\n\n【特徴】\n考えるより先に体が動く、圧倒的な行動力の星。じっとしているのが苦手。義理人情に厚く、頼られると断れないリーダー気質。\n\n【💰 ビジネス・人モテの活かし方】\nスピーディーに成果を出していく、泥臭くもカッコいい「背中」を見せること。その突破力に周囲が惚れ込みます。" },
            { head: "正官（せいかん）── 品格・エリートの星", body: "🔑 キーワード：責任感、気品、ルール\n\n【特徴】\n品格があり、社会のルールやモラルを大切にする。カチッとした場所や、伝統あるものが似合う正統派。\n\n【💰 ビジネス・人モテの活かし方】\n「きちんとしている感（品格・清潔感）」を全面に出すこと。ちゃんとした言葉遣いやフォーマルな装いが、最高のブランディングになります。" },
            { head: "偏印（へんいん）── 知的好奇心・放浪の星", body: "🔑 キーワード：自由、ニッチ、アイデア\n\n【特徴】\n占い、スピリチュアル、海外、最先端のITなど、ニッチで目新しいものが大好物。飽き性だが、ひらめきと企画力は天才的。\n\n【💰 ビジネス・人モテの活かし方】\n普通の人が思いつかない「マニアックなアイデア」や「旅・自由なライフスタイル」を発信すること。自由奔放さが魅力になります。" },
            { head: "印綬（いんじゅ）── 学問・母親の星", body: "🔑 キーワード：知性、教える、おっとり\n\n【特徴】\n勉強が大好きで、知識を深く探究するインテリの星。優しくおっとりしていて、人に何かを教えるのが得意。\n\n【💰 ビジネス・人モテの活かし方】\n先生ポジション（教科書・カリキュラムを作る側）に立つこと。分かりやすく知識を噛み砕いて教えることで、多くの生徒（ファン）に恵まれます。" },
        ] },
      ]
    },
  ];
