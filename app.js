  ...
  const KAISETSU_SECTIONS = [
    ...
    },
    {
      ...
      items: [
        ...
        { head: "🧸 C（印星）──「大人の振りした子供」の12タイプ", body: "地支が日干を生む関係のグループ。決めゼリフは「すべてわたしが中心です」。生じて「もらう」側なので中身は子供。", children: [
        ...
        { head: "🎩 A（食傷星）──「子供のふりした大人」の12タイプ", body: "日干が地支を生む関係のグループ。決めゼリフは「すべてわたしが基本です」。「与える」側なので中身は大人。", children: [
        ...
        { head: "👑 S（財星）──「どMのふりしたどS」の12タイプ", body: "日干が地支を剋す関係のグループ。決めゼリフは「すべてわたしが決めます」。「攻める」側なので本性はS。", children: [
        ...
        { head: "🎀 M（官星）──「どSのふりしたどM」の12タイプ", body: "地支が日干を剋す関係のグループ。決めゼリフは「すべてあなたが決めてください」。「受ける」側なので本性はM。", children: [
        ...
        { head: "🌀 P（比劫星）──「ひとたらしな自己中」の12タイプ", body: "日干と同じ五行関係のグループ。決めゼリフは「すべてわたしの気分です」。自分と同質なので自分中心。", children: [
