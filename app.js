...
(function () {
  ...
  const LIBRARY_PEOPLE = [
    ...
    { genre: "芸能・エンタメ", name: "ゆいびず", date: "2002/01/08", desc: "歌舞伎町のキャバ嬢・インフルエンサー。" },
    { genre: "芸能・エンタメ", name: "一条響", date: "1992/09/09", desc: "歌舞伎町の伝説的キャバ嬢。" },
    { genre: "芸能・エンタメ", name: "愛沢えみり", date: "1988/09/01", desc: "元歌舞伎町No.1キャバ嬢。アパレル等の実業家。" },
    { genre: "芸能・エンタメ", name: "明日花キララ", date: "1988/10/02", desc: "タレント・モデル・インフルエンサー。" },
    { genre: "芸能・エンタメ", name: "三上悠亜", date: "1993/08/16", desc: "タレント・インフルエンサー。" },
    { genre: "芸能・エンタメ", name: "嬉野ゆみ", date: "1996/07/24", desc: "インフルエンサー。" },
    { genre: "実業家", name: "小田切あさぎ", date: "1983/03/11", desc: "恋愛・自己実現の実業家・インフルエンサー。" },
    { genre: "実業家", name: "溝口勇児", date: "1984/11/23", desc: "FiNC創業。実業家・インフルエンサー。" },
    { genre: "実業家", name: "春木開", date: "1988/06/28", desc: "実業家・インフルエンサー（キングダム）。" },
    { genre: "芸能・エンタメ", name: "けーりん", date: "1980/07/25", desc: "インフルエンサー。" },
    { genre: "芸能・エンタメ", name: "鈴木亜美", date: "1988/09/27", desc: "インフルエンサー。" },
    { genre: "芸能・エンタメ", name: "Rちゃん", date: "1996/08/04", desc: "インフルエンサー。" },
    { genre: "芸能・エンタメ", name: "てんちむ", date: "1993/11/19", desc: "YouTuber・インフルエンサー。" },
    { genre: "芸能・エンタメ", name: "ヒカル", date: "1991/05/29", desc: "YouTuber・実業家。" },
    { genre: "芸能・エンタメ", name: "南柚子", date: "1998/09/20", desc: "キャバ嬢。" },
    { genre: "芸能・エンタメ", name: "Honami", date: "1987/10/13", desc: "インフルエンサー。" },
    ...
    { genre: "実業家", name: "黒米崇広", date: "1964/01/30", desc: "実業家。" },
    // スポーツ
  ...
  const KAISETSU_SECTIONS = [
    ...
    },
    {
      ...
      intro: "自分のNo.（60分類No）のところを開いてみてください。診断結果カードの「No.◯◯」がそのまま対応しています。動物キャラも一緒に載せています。",
      items: [
        { head: "そもそも「60干支」ってなに？", body: "四柱推命(しちゅうすいめい)は、生まれた「年・月・日・時間」の4つの柱から、その人の性格や運勢を読みとく占いです。なかでもいちばん大事なのが「生まれた日」の干支=日柱(にっちゅう)。これがその人の「性格の芯(しん)」を表すといわれます。\n\n干支は、10種類の「干(かん)」と12種類の「支(し)」(子・丑・寅…おなじみの十二支)の組み合わせでできていて、全部で60種類あります。\n\n10種類の「干」は、それぞれ自然のものにたとえられます。「たとえ=つまりこういう性格」まで訳すと、こうなります。" },
        { head: "【グループ】🌳 甲(きのえ)グループ — 大樹", body: "空に向かってまっすぐのびる大きな木。正直でウソがきらい、みんなを引っぱるリーダータイプ。そのぶん「曲げない・折れない」がんこさも持っています。木が立つ場所(季節や環境)によって、6つの個性に分かれます。" },
        ...
        { head: "【グループ】🌷 乙(きのと)グループ — 草花", body: "風がふいてもしなって折れない、草や花のイメージ。やわらかくて協調性があり、どんな場所でも根を張れるたくましさが魅力。「おだやかに見えて、実はねばり強い」のが乙グループの合言葉です。" },
        ...
        { head: "【グループ】☀️ 丙(ひのえ)グループ — 太陽", body: "みんなを平等に照らす太陽のイメージ。明るくてかくしごとがなく、いるだけで場がパッと明るくなる存在。太陽は自分から輝くので、目立つこと・注目されることが自然と似合います。" },
        ...
        { head: "【グループ】🕯️ 丁(ひのと)グループ — 灯火", body: "ろうそくや焚き火、夜空の星のような炎のイメージ。太陽ほど派手ではないけれど、暗いところでこそ輝く光。繊細で感受性が豊かで、心の中に静かな情熱を燃やしています。" },
        ...
        { head: "【グループ】⛰️ 戊(つちのえ)グループ — 山", body: "何百年も動かず、どっしりかまえる大きな山のイメージ。安定感と信頼感はナンバーワン。ちょっとやそっとのことでは動じない、たのもしい存在です。そのぶん、一度決めたら動かない「がんこさ」も山クラス。" },
        ...
        { head: "【グループ】🌾 己(つちのと)グループ — 畑", body: "野菜や花を育てる、栄養たっぷりの畑のイメージ。人を育てたり支えたりするのが得意な、めんどう見のいいタイプ。知識をどんどん吸収してたくわえる「学びの土」でもあります。" },
        ...
        { head: "【グループ】⚔️ 庚(かのえ)グループ — 刀・鉄", body: "鍛えれば鍛えるほど強く、鋭くなる刀や鉄のイメージ。決断力と行動力にすぐれ、ものごとをスパッと割り切れるタイプ。試練や努力が、そのままこの人の「切れ味」になります。" },
        ...
        { head: "【グループ】💎 辛(かのと)グループ — 宝石", body: "磨かれてこそ輝く宝石のイメージ。繊細で美意識が高く、プライドはひそかに高め。苦労や努力という「研磨」を経るほど、だれにもまねできない輝きを放つタイプです。" },
        ...
        { head: "【グループ】🌊 壬(みずのえ)グループ — 海", body: "大きく自由に流れる海や大河のイメージ。発想がのびのびしていて、細かいことにこだわらないスケールの大きさが魅力。どんなものも受け入れる包容力と、じっとしていられない自由な心を持っています。" },
        ...
        { head: "【グループ】☔ 癸(みずのと)グループ — 雨", body: "大地にしみこみ、命を育てる雨や湧き水のイメージ。10種類の干のいちばん最後で、やさしさと知性を静かにたくわえたタイプ。派手さはなくても、雨がないと花が咲かないように、なくてはならない存在です。" },
