...
(function () {
  ...
  const LIBRARY_PEOPLE = [
    ...
    { genre: "実業家", name: "斉藤一人", date: "1978/08/03", desc: "「銀座まるかん」創業者。実業家・著述家。" },
    ...
    { genre: "実業家", name: "田中綋", date: "1962/05/06", desc: "カカクコム（価格.com・食べログ）を育てた経営者。" },
    ...
    { genre: "フォーブス日本2014", name: "毒島邦雄", date: "1952/09/30", desc: "5位 SANKYO｜パチンコ機大手。長男らと財務体質・トップシェアを維持。" },
    ...
    { genre: "フォーブス日本2014", name: "大塚裕司", date: "1953/11/01", desc: "14位 大塚商会｜中小企業向けIT一括管理サービスで成功。" },
    { genre: "フォーブス日本2014", name: "木下盛好", date: "1949/03/12", desc: "15位 アコム｜創業者の息子。三菱UFJ傘下で安定。" },
    { genre: "フォーブス日本2014", name: "安田隆夫", date: "1949/05/15", desc: "16位 ドン・キホーテ(PPIH)｜圧縮陳列・深夜営業で小売の異端児として君臨。" },
    ...
    { genre: "フォーブス日本2014", name: "多田勝美", date: "1945/11/11", desc: "22位 大東建託｜アパート建築から賃貸管理まで一括モデルで成功。" },
    ...
    { genre: "フォーブス日本2013", name: "毒島邦雄", date: "1952/09/30", desc: "8位 SANKYO｜パチンコ・パチスロ機器で圧倒的シェアとキャッシュフロー。" },
    ...
    { genre: "フォーブス日本2013", name: "大塚裕司", date: "1953/11/01", desc: "14位 大塚商会｜中小企業へのITシステム・複合機導入で顧客基盤を確立。" },
    { genre: "フォーブス日本2013", name: "安田隆夫", date: "1949/05/15", desc: "15位 ドン・キホーテ(PPIH)｜深夜営業とアミューズメント性で成長。" },
    ...
    { genre: "フォーブス日本2013", name: "多田勝美", date: "1945/11/11", desc: "24位 大東建託｜地主向けアパート建築と一括借上で独走。" },
